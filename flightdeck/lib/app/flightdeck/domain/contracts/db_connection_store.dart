...
/// `.flightdeck/databases.json` (versionado), overlay pessoal em
/// `.flightdeck/databases.local.json` (gitignored, merge por cima, por nome) e
...
/// chamador (`flightdeck.db.<workspaceId>.<nome>`). Falhas do cofre lançam —
