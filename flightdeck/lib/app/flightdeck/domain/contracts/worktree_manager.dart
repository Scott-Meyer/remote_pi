...
/// Lado **mutável** do git pro FlightDeck: listar/criar/remover worktrees. Contrato
...
abstract class WorktreeManager {
  ...
  /// Cria uma worktree em `<repoPath>/.flightdeck/worktrees/<name>` numa branch
  /// **nova** [name] (decisões 2, 3, 15), garantindo antes que
  /// `.flightdeck/worktrees/` está no `.gitignore` do repo. A base é o HEAD atual
