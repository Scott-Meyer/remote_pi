...
import 'package:flightdeck/app/flightdeck/data/remote/pty_ack_batcher.dart';
...
import 'package:flightdeck/app/core/utils/spawn_directory.dart'
    show SpawnDirectory;
import 'package:flightdeck_core/flightdeck_core.dart';
import 'package:flightdeck_remote/flightdeck_remote.dart';

/// [TerminalGateway] de um workspace REMOTO: o PTY roda no `flightdeck-server`
...
class RemoteHostTerminalGateway implements TerminalGateway {
  ...
  Future<void> _onReconnected(RemoteTerminalService service) async {
    ...
    try {
      ...
      // E o caso é comum: se o host ficou fora do ar, o flightdeck-server de lá
