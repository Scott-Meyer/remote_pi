...
/// Conexões do workspace em `.flightdeck/databases.json` (versionado) +
/// `.flightdeck/databases.local.json` (gitignored, override por nome) + sqlites
...
class DbConnectionStoreImpl implements DbConnectionStore {
  ...
  static const _dirName = '.flightdeck';
