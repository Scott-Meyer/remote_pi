...
class LocalNotifier implements Notifier {
  /// AppUserModelID do FlightDeck no Windows. Mesmo valor do `app_id` do
  /// empacotamento (`windows/packaging/exe/make_config.yaml`) e do bundle id
  /// do macOS — identifica o app na central de notificações.
  static const String _windowsAppUserModelId = 'dev.flightdeck.desktop';
  ...
  Future<void> init() async {
    ...
    final settings = InitializationSettings(
      ...
      linux: LinuxInitializationSettings(
        defaultActionName: t.flightdeck.notifications.open,
      ),
  ...
  }) => _show(t.flightdeck.notifications.agentFinished, agentName, workspace);

  @override
  Future<void> agentNeedsAction({
    required String agentName,
    required String workspace,
  }) => _show(t.flightdeck.notifications.agentNeedsAction, agentName, workspace);

  @override
  Future<void> agentCrashed({
    required String agentName,
    required String workspace,
  }) => _show(t.flightdeck.notifications.agentCrashed, agentName, workspace);
