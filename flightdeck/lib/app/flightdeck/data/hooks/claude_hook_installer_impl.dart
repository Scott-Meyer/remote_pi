...
///
/// - Faz **append idempotente** de um entry marcado (`_flightdeck`) em cada evento,
...
///   aqui que a migração acontece: o entry velho apontando pro `flightdeck-hook` é
...
class ClaudeHookInstallerImpl extends HookInstallerBase {
  ...
  /// aponta pro helper (`flightdeck-hook` legado ou `<cli> hook`). O segundo
