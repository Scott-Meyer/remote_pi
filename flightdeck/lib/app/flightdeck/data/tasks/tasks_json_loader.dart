...
import 'package:flightdeck/app/core/data/jsonc.dart';
...
/// Lê o `.flightdeck/tasks.json` (manual, versionável) de um workspace e o traduz
...
/// `.flightdeck/`), per-task; top-level `cwd` é só default. Ver plano 48.
class TasksJsonLoader {
  ...
  static String pathFor(String workspaceCwd) =>
      joinPath(joinPath(workspaceCwd, '.flightdeck'), 'tasks.json');
