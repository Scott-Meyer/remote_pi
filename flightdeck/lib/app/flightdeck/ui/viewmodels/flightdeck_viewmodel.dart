...
import 'package:flightdeck/app/flightdeck/domain/contracts/app_launcher.dart';
import 'package:flightdeck/app/flightdeck/domain/services/db_query_service.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/content_searcher.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/file_reader.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/file_searcher.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/file_system_reader.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/folder_lister.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/git_command_runner.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/git_diff_reader.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/git_history_reader.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/scm_line_decorations.dart';
import 'package:flightdeck/app/flightdeck/domain/exceptions/git_history_error.dart';
import 'package:flightdeck/app/flightdeck/domain/services/scm_baseline_cache.dart';
import 'package:flightdeck/app/flightdeck/domain/services/scm_line_decoration_calculator.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/http_request_runner.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/layout_loader.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/project_repository.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/rpc_gateway_factory.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/session_history.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/terminal_gateway_factory.dart';
import 'package:flightdeck/app/core/domain/contracts/terminal_profile_resolver.dart';
import 'package:flightdeck/app/core/domain/entities/terminal_profile.dart';
import 'package:flightdeck/app/core/domain/entities/app_settings.dart';
import 'package:flightdeck/app/core/domain/entities/sound_event.dart';
import 'package:flightdeck/app/core/domain/entities/automation.dart';
import 'package:flightdeck/app/core/domain/exceptions/automation_error.dart';
import 'package:flightdeck/app/core/domain/exceptions/file_operation_error.dart';
import 'package:flightdeck/app/core/domain/services/commit_message_prompt.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/terminal_status_server.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/workspace_layout_store.dart';
import 'package:flightdeck/app/flightdeck/domain/contracts/worktree_manager.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/content_search.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/file_diff.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/file_node.dart';
...
import 'package:flightdeck/app/flightdeck/domain/entities/file_view.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/kanban_document.dart';
import 'package:flightdeck/app/flightdeck/domain/services/kanban_editor.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/git_commit.dart';
...
import 'package:flightdeck/app/flightdeck/domain/git_history_parsers.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/layout_spec.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/git_file_status.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/git_info.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/launchable_app.dart';
...
import 'package:flightdeck/app/flightdeck/domain/value_objects/uid.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/session_info.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/thinking_level.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/worktree.dart';
import 'package:flightdeck/app/flightdeck/domain/services/worktree_reconciler.dart';
import 'package:flightdeck/app/flightdeck/ui/session/scm_line_decoration_coordinator.dart';
import 'package:flightdeck/app/core/data/lsp/lsp_server_pool.dart';
import 'package:flightdeck/app/core/data/lsp/lsp_text_edit.dart';
import 'package:flightdeck/app/core/domain/entities/lsp_diagnostic.dart';
import 'package:flightdeck/app/core/domain/entities/lsp_semantic_tokens.dart';
import 'package:flightdeck/app/core/domain/result.dart';
import 'package:flightdeck/app/core/ui/automation_controller.dart';
import 'package:flightdeck/app/core/utils/path_utils.dart';
import 'package:flightdeck/app/core/utils/platform_kind.dart';
import 'package:flightdeck/app/core/utils/user_home.dart';
import 'package:flightdeck/app/flightdeck/ui/session/agent_session.dart';
import 'package:flightdeck/app/flightdeck/ui/session/diff_viewer_session.dart';
...
import 'package:flightdeck/app/flightdeck/domain/contracts/terminal_scrollback_store.dart';
...
import 'package:flightdeck/app/flightdeck/ui/states/pane_node.dart';
import 'package:flightdeck/app/flightdeck/ui/viewmodels/flightdeck_cli_handler.dart';
import 'package:flightdeck_remote/flightdeck_remote.dart' show RemoteCliCommand;
import 'package:flightdeck/app/flightdeck/data/filesystem/unified_diff_parser.dart';
...
import 'package:flightdeck_core/flightdeck_core.dart' show GitException, GitRunResult;
import 'package:flightdeck_remote/flightdeck_remote.dart'
...
import 'package:flightdeck/app/flightdeck/ui/viewmodels/file_ops_controller.dart';
import 'package:flightdeck/app/flightdeck/ui/viewmodels/git_controller.dart';
import 'package:flightdeck/app/flightdeck/ui/viewmodels/realm_controller.dart';
import 'package:flightdeck/app/flightdeck/ui/viewmodels/session_notifications_controller.dart';
import 'package:flightdeck/app/flightdeck/ui/viewmodels/remote_workspace_controller.dart';
...
class FlightDeckViewModel extends ChangeNotifier {
  FlightDeckViewModel(
    this._projects,
    this._factory,
    this._folders,
    ...
    git
      ...
      // Pathless (FlightDeck + hosts remotos): git local não sobe (path vazio).
  ...
  /// selecionado + seus forks); vazio quando nada/FlightDeck selecionado.
  ...
  /// Motor de queries da DB tab — compartilhado com a CLI `flightdeck db`
  /// (plano 51): mesma resolução de conexão/senha, mesma serialização.
  final DbQueryService _dbService;

  /// Motor de requests da HTTP tab — compartilhado com a CLI `flightdeck http`,
  ...
  /// Espelha `AppSettings.showFlightDeck` (app-scoped, empurrado pela `FlightDeckPage`).
  /// Governa se o workspace de sistema "FlightDeck" é injetado. Default `true`;
  /// antes de [init] terminar só guarda a flag (a injeção acontece no [init]).
  bool _flightdeckEnabled = true;
  ...
  /// Persiste a visibilidade dos painéis (rail/árvore). A `FlightDeckPage` injeta o
  ...
  /// app-scoped (a `FlightDeckPage` empurra; a VM é page-scoped e não o enxerga).
  ...
  /// Espelha `AppSettings.defaultTerminalProfileId` (plano 50). A `FlightDeckPage`
  ...
  /// FlightDeck sintético) — o nível de topo da lista de projetos do rail. O
  /// FlightDeck é renderizado num slot próprio via [flightdeckWorkspace] e fica de
    ...
    final roots = _projectList
        .where(
          (p) =>
              ...
              // locais; só o FlightDeck sintético (systemTerminal) fica de fora.
              !p.isSystemTerminal &&
  ...
  /// O workspace de sistema "FlightDeck" (terminal-only), se estiver habilitado e
  /// injetado; `null` caso contrário. Renderizado num slot próprio no rail.
  Project? get flightdeckWorkspace => _projectById(Project.flightdeckId);

  /// `true` se [id] é o workspace de sistema "FlightDeck". Chokepoint usado pelos
  ...
  /// `true` se [id] é um workspace SEM pasta local (FlightDeck ou host remoto):
  ...
  /// ([FlightDeckCliHandler]) pra list-panes/resolução por label.
  ...
  /// terminal que emitiu o `flightdeck open`.
  ...
  /// Handler da CLI interna `flightdeck` — colaborador extraído; criado aqui
  /// (e não no módulo) porque referencia o próprio VM.
  late final FlightDeckCliHandler _cli = FlightDeckCliHandler(
    this,
    _dbService,
    _httpRunner,
    _taskDiscovery,
  ...
  /// host remoto, senão o path local. Vazio = sem árvore (FlightDeck/sem seleção).
  ...
  /// remoto); `false` pro FlightDeck (systemTerminal, sem pasta).
  ...
  static const Map<String, String> _remoteCliRefusals = <String, String>{
    'browse':
        'browse runs on the FlightDeck machine, so a URL from this host '
    ...
    'mongo-browse':
        ...
        '(localhost included) would not resolve there',
    'http-run':
        'the request would leave from the FlightDeck machine, not from this '
  ...
  /// [FlightDeckCliHandler] da CLI local depois de aplicar a política do que pode
  ...
  Future<void> _onRemoteCliCommand(RemoteCliCommand command) async {
    ...
    final result = await _cli.handle(
      FlightDeckCommand(cmd: cmd, tabId: tabId, args: args),
    );
    if (result.ok) {
  ...
  /// do auto-open de task e do `flightdeck browse`.
  ...
  /// (`dev.ckp` → `dev-2.ckp`…), salvo `fixedName` (ex.: `.flightdeck/tasks.json`),
  ...
  Future<void> init() async {
    // Servidor de status do `flightdeck-hook` (claude nas abas reporta turno aqui).
    // Await: no Windows o `hookEnv` depende da porta ligada antes de spawnar abas.
    // O mesmo socket atende a CLI interna `flightdeck` (`_onFlightDeckCommand`).
    await _statusServer.start(_onClaudeStatus, onCommand: _cli.handle);
    // Turn-status REMOTO (plano 60, Wave G): o hook roda no host, o flightdeck-
    ...
    // CLI `flightdeck` rodando NUM HOST remoto: o comando viaja pelo protocolo e
    ...
    final selected = _selectedProjectId;
    // `init()` é chamado fire-and-forget pelo `FlightDeckPage` (sem await, sem
  ...
  ///    (inclui o próprio FlightDeck);
  /// 2. senão, o FlightDeck (1º boot de instalação nova: sem `lastSelected`);
  ...
  Future<String?> _initialSelection() async {
    ...
    if (flightdeckWorkspace != null) return Project.flightdeckId;
    final roots = rootProjects;
    return roots.isEmpty ? null : roots.first.id;
  }

  /// `true` se [id] pode ser selecionado com o realm ativo atual: o FlightDeck
  ...
  /// Adiciona o workspace de sistema "FlightDeck" a [_projectList] (runtime, nunca
  ...
  /// num slot próprio via [flightdeckWorkspace]).
  void _injectFlightDeck() {
    // Mobile (plano 59): sem shell local, o pseudo-workspace "FlightDeck"
    // (systemTerminal) não existe — o mobile é remote-only. Nunca injeta,
    // independente de `showFlightDeck`.
    if (isMobilePlatform) return;
    if (_projectById(Project.flightdeckId) != null) return;
  ...
  /// Liga/desliga o workspace de sistema "FlightDeck" em runtime (empurrado pela
  /// `FlightDeckPage` a partir de `AppSettings.showFlightDeck`).
  ///
  ...
  /// - **OFF**: mata os PTYs do FlightDeck e remove o slot; se estava selecionado,
  ///   cai no primeiro workspace real (ou `null` → `WelcomeView`). Sem diálogo.
  void setFlightDeckEnabled(bool value) {
    if (_flightdeckEnabled == value) return;
    _flightdeckEnabled = value;
    ...
    // (ver [removeProject]).
    final wasSelected = _selectedProjectId == Project.flightdeckId;
    _projectList.removeWhere((p) => p.isSystemTerminal);
    unawaited(_disposeRuntimeAfterFrame(Project.flightdeckId));
    if (wasSelected) {
      final roots = rootProjects;
  ...
  /// (fallback: FlightDeck → primeiro workspace → nenhum).
  Future<void> switchRealm(String id) async {
    ...
    if (next == null && flightdeckWorkspace != null) next = Project.flightdeckId;
    if (next == null) {
      final roots = rootProjects;
  ...
  Future<void> moveWorkspaceToRealm(String workspaceId, String realmId) async {
    ...
    if (realmId != realmCtrl.activeId &&
      ...
      final roots = rootProjects;
      final next = flightdeckWorkspace != null
          ? Project.flightdeckId
  ...
  Future<Project> addProject(
    ...
    // Cor pela contagem de raízes (forks e o FlightDeck sintético não entram no
  ...
  /// FlightDeck (se ligado), senão `null` — rail vazio → `WelcomeView`.
  String? _selectionAfterClosing(String excluding) {
    for (final p in rootProjects) {
      if (p.id != excluding) return p.id;
    }
    return flightdeckWorkspace != null ? Project.flightdeckId : null;
  }
  ...
  void selectProject(String id) {
    ...
    // `flightdeck open`, restauração): troca o realm ativo junto — selecionar um
  ...
  /// (`flightdeck new-tab`), que não passa pelo dialog nem por subpasta relativa.
  ...
  PaneItem _spawn(
    ...
    final project = selectedProject!;
    // Workspace remoto (via SSH): PTY no flightdeck-server do host, na PASTA do
    ...
    // FlightDeck (terminal-only, sem pasta): shell sempre no HOME do usuário,
  ...
  TerminalSession _buildTerminal(
    ...
    final t = TerminalSession(
      ...
      // O `flightdeck-hook` do claude herda e reporta status de turno de volta.
      // `FLIGHTDECK_TAB_ID` é o nome correto (o que a CLI endereça é uma tab);
      // `FLIGHTDECK_PANE_ID` fica como alias legado (hook + binários antigos).
      spawnEnv: <String, String>{
        'FLIGHTDECK_TAB_ID': id,
        'FLIGHTDECK_PANE_ID': id,
        if (_projectById(projectId) != null) ...{
          'FLIGHTDECK_WORKSPACE_ID': projectId,
          'FLIGHTDECK_WORKSPACE_NAME': _projectById(projectId)!.name,
        },
        ..._statusServer.hookEnv,
        // PATH escopado → o binário `flightdeck` (CLI interna) resolve só nas abas.
  ...
  /// Env de PATH escopado: prepend o diretório da CLI (onde o binário `flightdeck`
  /// é materializado no boot) ao PATH **só dos terminais do FlightDeck** — a CLI
  ...
  void _scheduleSave(String projectId) {
    // O FlightDeck é efêmero (sessão só enquanto o app vive) — nunca persiste
