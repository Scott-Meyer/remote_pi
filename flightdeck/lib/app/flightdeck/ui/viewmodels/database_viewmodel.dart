...
import 'package:flightdeck/app/flightdeck/domain/services/redis_browse_service.dart';
...
/// 51). Page-scoped (provido no `flightdeck_module`); o workspace ativo entra
...
class DatabaseViewModel extends ChangeNotifier {
  ...
  /// `.flightdeck/databases.json` de um workspace remoto vive no host. O app o
  ...
  /// caminho absoluto (o painel abre via FlightDeckViewModel). [table] preenche
