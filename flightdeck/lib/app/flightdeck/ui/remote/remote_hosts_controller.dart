...
import 'package:flightdeck/app/core/utils/remote_path.dart';
import 'package:flightdeck/app/flightdeck/data/remote/remote_host_password_store.dart';
import 'package:flightdeck/app/flightdeck/data/remote/remote_host_terminal_gateway.dart';
...
/// o [FlightDeckViewModel] pede o gateway de terminal de um host por aqui.
class RemoteHostsController extends ChangeNotifier {
  ...
  /// Comandos da CLI `flightdeck` de TODOS os hosts, mesclados — a VM assina e
  /// devolve ao `FlightDeckCliHandler`, o mesmo que atende a CLI local.
