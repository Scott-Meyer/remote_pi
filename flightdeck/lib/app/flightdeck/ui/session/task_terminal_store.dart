...
import 'package:flightdeck/app/core/terminal/json_log_highlighter.dart';
...
///
/// App-scoped (bind no `flightdeck_module`); criado já no mount da `FlightDeckViewModel`
...
class TaskTerminalStore {
  ...
  final _terminals = <String, FlightDeckTerminalController>{};
  ...
  /// `flightdeck read-task` — criar aqui registraria um buffer fantasma).
  ...
  FlightDeckTerminalController? existingTerminal(String taskId) =>
      _terminals[taskId];

  FlightDeckTerminalController terminalFor(
    String taskId, {
  ...
  Future<void> _seed(String taskId, FlightDeckTerminalController term) async {
