...
/// porque o `DbQueryException` é do domínio do flightdeck — e o core não importa
/// de feature nenhuma.
///
...
/// FlightDeck inventa, e aí a frase nasce aqui.
///
...
String dbErrorMessage(BuildContext context, DbQueryException e) =>
    switch (e.kind) {
      ...
      'password_required' => context.t.flightdeck.dbPanel.passwordRequired,
      _ => e.message,
    };
