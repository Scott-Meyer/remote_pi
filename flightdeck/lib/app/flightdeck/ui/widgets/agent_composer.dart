...
import 'package:flightdeck/app/flightdeck/domain/entities/pi_command.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/prompt_image.dart';
import 'package:flightdeck/app/flightdeck/domain/entities/rpc_event.dart'
    show RelayStatus;
...
import 'package:flightdeck/app/core/ui/activity_periodic_timer.dart';
...
import 'package:flightdeck/app/flightdeck/ui/widgets/model_picker.dart';
...
class _AgentComposerState extends State<AgentComposer> {
  ...
  void initState() {
    ...
    // Registra o foco do input pra o atalho ⌘L/Ctrl+L (em FlightDeckPage).
  ...
  Future<void> _pickAttachment() async {
    final result = await FilePicker.platform.pickFiles(
      allowMultiple: true,
      withData: true,
      dialogTitle: context.t.flightdeck.agentComposer.attachFile,
    );
    ...
    showToast(
      ...
      builder: (context, overlay) => SurfaceCard(
        child: Padding(
          ...
          child: Text(
            context.t.flightdeck.agentComposer.maxImages(max: _maxImages),
          ),
        ),
      ),
    );
  ...
  List<PiCommand> get _builtins {
    final tr = context.t.flightdeck.agentComposer;
    return <PiCommand>[
        ...
        builder: (context, candidate, rejected) {
                  ...
                  child: Focus(
                    ...
                    child: CallbackShortcuts(
                      ...
                      child: TextField(
                        ...
                        placeholder: Text(
                          context.t.flightdeck.agentComposer.placeholder,
                          style: context.typo.body.copyWith(
                            fontSize: 13.5,
                            color: colors.text3,
                          ),
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      _BarIcon(
                        icon: Icons.add,
                        tooltip: context.t.flightdeck.agentComposer.attachFile,
          ...
          return Stack(
            ...
            children: [
              ...
              if (context.select<FlightDeckViewModel, bool>(
...
class _ModelChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _Chip(
      ...
      label: model?.name ?? context.t.flightdeck.agentComposer.modelFallback,
...
class _ContextGauge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppTooltip(
      message: context.t.flightdeck.agentComposer.contextTooltip(pct: pct),
      child: Padding(
...
class _SendButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppTooltip(
      message: streaming
          ? context.t.flightdeck.agentComposer.stop
          : context.t.flightdeck.agentComposer.send,
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Flexible(
              child: Text(
                context.t.flightdeck.agentComposer.visionWarning,
