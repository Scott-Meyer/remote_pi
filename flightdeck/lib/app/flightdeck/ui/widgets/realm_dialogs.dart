        ...
        child: Column(
          ...
          children: [
            TextField(
              controller: _name,
              autofocus: true,
              placeholder: Text(context.t.flightdeck.realmDialogs.namePlaceholder),
            ...
            if (_trimmed.isNotEmpty && !_valid) ...[
              ...
              Text(
                context.t.flightdeck.realmDialogs.duplicateName,
...
/// [FlightDeckViewModel] por construtor (dialogs vivem no overlay do navigator,
...
Future<void> showRealmManagerDialog(
  BuildContext context, {
  required FlightDeckViewModel vm,
}) {
...
class _RealmManagerDialog extends StatelessWidget {
  ...
  Future<void> _create(BuildContext context) async {
    final tr = context.t.flightdeck.realmDialogs;
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(
        context.t.flightdeck.realmDialogs.manageRealmsTitle,
        style: context.typo.title.copyWith(fontSize: 15, color: colors.text),
      ),
      content: ConstrainedBox(
      ...
      actions: [
        OutlineButton(
          ...
          child: Text(context.t.flightdeck.realmDialogs.newRealmTitle),
        ),
        PrimaryButton(
          onPressed: () => Navigator.of(context).pop(),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  context.t.flightdeck.realmDialogs.workspaceCount(n: count),
