            ...
            Wrap(
              ...
              children: [
                _ActionCard(
                  ...
                  title: context.t.flightdeck.emptyPane.newAgent,
                  description: context.t.flightdeck.emptyPane.newAgentDescription,
                  onTap: onNewAgent,
                ),
                _ActionCard(
                  icon: Icons.terminal_outlined,
                  iconColor: colors.text2,
                  title: context.t.flightdeck.emptyPane.newTerminal,
                  description:
                      context.t.flightdeck.emptyPane.newTerminalDescription,
                  onTap: onNewTerminal,
                ),
              ],
            ),
