...
/// Dialog informativo genérico (tema do flightdeck) — só botão "OK".
...
Future<CloseDirtyChoice> showCloseDirtyDialog(
  ...
  final result = await showDialog<CloseDirtyChoice>(
    ...
    builder: (context) {
      final colors = context.colors;
      final tr = context.t.flightdeck.confirmDialog;
      return AlertDialog(
        title: Text(
...
/// Dialog de confirmação genérico (tema do flightdeck). Devolve `true` se confirmar.
