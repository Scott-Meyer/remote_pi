...
import 'package:flightdeck/app/core/ui/http_request_error_message.dart';
...
class _HttpRequestViewState extends State<HttpRequestView> {
  ...
  Future<bool> _save() async {
    ...
    if (widget.session.scratch) {
      ...
      if (error != null) {
        _showError(
          context.t.flightdeck.httpView.couldNotSave,
  ...
  Future<String?> _promptName() {
    ...
    return showDialog<String>(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: Text(
            context.t.flightdeck.httpView.saveRequestAs,
    ...
    final picked = await showAppMenu<int>(
      ...
      items: [
        ...
        if (doc.requests.isEmpty)
          AppMenuItem(
            value: -1,
            label: context.t.flightdeck.httpView.noRequests,
            enabled: false,
          ),
      ],
    );
  ...
  Widget _topBar(BuildContext context) {
    ...
    final tr = context.t.flightdeck.httpView;
    final doc = _doc;
