...
class AgentTranscript extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (entries.isEmpty) {
      return Center(
        child: Text(
          context.t.flightdeck.transcript.startHint,
      ...
      WorkedEntry(:final duration) => Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              context.t.flightdeck.transcript.workedFor(
    ...
    switch (entry.method) {
      ...
      case 'editor':
        return _InputRow(
          controller: _input,
          hint:
              entry.placeholder ?? context.t.flightdeck.transcript.typeYourAnswer,
          onSubmit: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        _ChoiceButton(
          label: context.t.flightdeck.transcript.send,
          filled: true,
          onTap: onSubmit,
        ),
      ],
