...
import 'package:flightdeck/app/flightdeck/domain/entities/task_run.dart';
...
class _TasksPanelState extends State<TasksPanel> {
                    ...
                    children: [
                      for (final def in vm.tasks)
                        _TaskRow(
                          ...
                          onTap: () => context
                              .read<FlightDeckViewModel>()
                              .openTaskOutput(def.id, def.label),
                          // Play também já abre a aba dos logs.
                          onStart: () {
                            vm.start(def);
                            context.read<FlightDeckViewModel>().openTaskOutput(
                              def.id,
                              def.label,
                            );
                          },
  ...
  /// Estado vazio: mensagem + (se não há `.flightdeck/tasks.json`) um botão que
  ...
  Widget _empty(BuildContext context, TasksViewModel vm) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.t.flightdeck.tasksPanel.noTasks,
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      context.t.flightdeck.tasksPanel.createTasksJson,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            context.t.flightdeck.tasksPanel.sectionTasks,
          ...
          if (vm.loading)
            ...
            _IconAction(
              tooltip: context.t.flightdeck.tasksPanel.reloadTasksTooltip,
              icon: Icons.refresh,
              onTap: vm.reload,
            ),
        ],
        ...
        children: [
          ...
          if (active) ...[
            for (final k in def.interactiveKeys.where((k) => k.primary))
              _IconAction(
                tooltip: context.t.flightdeck.tasksPanel.sendsKeyTooltip(
                  label: k.label,
                  key: k.key,
                ),
            ...
            if (!def.interactiveKeys.any(
              ...
              _IconAction(
                tooltip: context.t.flightdeck.tasksPanel.restartTooltip,
                icon: Icons.restart_alt,
                onTap: onRestart,
              ),
            _IconAction(
              tooltip: context.t.flightdeck.tasksPanel.stopTooltip,
              icon: Icons.stop,
              color: colors.error,
              onTap: onStop,
            ),
            ...
            AppTooltip(
              message: run.status == TaskRunStatus.starting
                  ? context.t.flightdeck.tasksPanel.startingTooltip
                  : context.t.flightdeck.tasksPanel.stoppingTooltip,
              child: const Padding(
            ...
            _IconAction(
              tooltip: context.t.flightdeck.tasksPanel.runTooltip,
...
class _ProfileChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppTooltip(
      message: context.t.flightdeck.tasksPanel.switchProfileTooltip,
      child: HoverTap(
        borderRadius: BorderRadius.circular(5),
        onTap: onTap,
        child: chip,
...
class _OverflowKeys extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _IconAction(
      tooltip: context.t.flightdeck.tasksPanel.moreKeysTooltip,
      icon: Icons.keyboard,
      onTap: () async {
