...
class _MongoCollectionViewState extends State<MongoCollectionView> {
  ...
  Future<void> _delete(int ix) async {
    ...
    final id = doc['_id'];
    final tr = context.t.flightdeck.dbMongoView;
        ...
        return Padding(
          ...
          child: Center(
            child: OutlineButton(
              onPressed: _loadMore,
              child: Text(
                context.t.flightdeck.dbMongoView.loadMore,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                if (!editing) ...[
                  AppTooltip(
                    message: context.t.flightdeck.dbMongoView.edit,
                    child: HoverTap(
                      onTap: () => _startEdit(ix),
            ...
            Row(
              ...
              children: [
                ...
                PrimaryButton(
                  ...
                  child: Text(context.t.flightdeck.dbMongoView.insert),
                ),
              ],
            ),
          ],
