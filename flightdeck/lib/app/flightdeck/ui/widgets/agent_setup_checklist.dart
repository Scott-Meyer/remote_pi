import 'package:flightdeck/app/flightdeck/domain/entities/install_result.dart';
...
/// agora dispara sob demanda (decisão: FlightDeck como multiplexador não exige o
...
class _AgentSetupChecklistState extends State<AgentSetupChecklist>
  ...
  Widget build(BuildContext context) {
    ...
    final tr = context.t.flightdeck.agentSetupChecklist;
      ...
      child: Row(
        children: [
          ...
          if (status != CheckStatus.notApplicable)
            AppTooltip(
              message: context.t.flightdeck.agentSetupChecklist.checkAgain,
              child: HoverTap(
  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      ...
      case CheckStatus.notApplicable:
        return AppTooltip(
          message: context.t.flightdeck.agentSetupChecklist.notRequired,
          child: Icon(
        ...
        child: result == null
            ? Row(
                children: [
                  ...
                  const SizedBox(width: 12),
                  Text(
                    context.t.flightdeck.agentSetupChecklist.installing,
                    style: context.typo.body.copyWith(
                      fontSize: 13.5,
                      color: colors.text2,
                    ),
