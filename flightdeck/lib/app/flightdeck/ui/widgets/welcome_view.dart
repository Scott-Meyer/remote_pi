...
/// **não** força instalar nada: o FlightDeck serve como multiplexador de terminal
...
class WelcomeView extends StatelessWidget {
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                context.t.flightdeck.welcomeView.title,
              ...
              Text(
                context.t.flightdeck.welcomeView.subtitle,
  ...
  Widget _actions(BuildContext context) {
    final tr = context.t.flightdeck.welcomeView;
    if (isMobilePlatform) {
