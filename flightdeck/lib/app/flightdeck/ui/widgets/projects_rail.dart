...
class ProjectsRail extends StatefulWidget {
  const ProjectsRail({
    ...
    this.flightdeck,
    required this.onSelectFlightDeck,
  ...
  /// O workspace de sistema "FlightDeck" (terminal-only), renderizado num slot
  /// fixo no topo, separado da lista de projetos. `null` quando desabilitado.
  final Project? flightdeck;

  /// Seleciona o workspace de sistema "FlightDeck".
  final VoidCallback onSelectFlightDeck;
    ...
    return Container(
      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(
                  context.t.flightdeck.projectsRail.workspaces,
                ...
                Builder(
                  builder: (btnContext) => _SmallIcon(
                    icon: Icons.add,
                    tooltip: context.t.flightdeck.projectsRail.newWorkspace,
          ...
          // Slot fixo do workspace de sistema "FlightDeck" (terminal-only), acima
          // e separado da lista de projetos. Sem avatar/imagem, sem menu ⋮.
          if (widget.flightdeck != null)
            Padding(
              padding: const EdgeInsets.fromLTRB(8, 0, 8, 4),
              child: _FlightDeckSlot(
                selected: widget.flightdeck!.id == widget.selectedId,
                onTap: widget.onSelectFlightDeck,
              ),
            ),
            ...
            child: Row(
              children: [
                ...
                _SmallIcon(
                  ...
                  tooltip: context.t.flightdeck.projectsRail.settings,
...
class _WorktreeSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      context.t.flightdeck.projectsRail.worktreeCount(n: count),
...
class _WorktreeChevron extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tr = context.t.flightdeck.projectsRail;
    return AppTooltip(
...
/// Slot fixo do workspace de sistema "FlightDeck": glifo de terminal + rótulo, sem
...
class _FlightDeckSlot extends StatelessWidget {
  const _FlightDeckSlot({required this.selected, required this.onTap});
  ...
  Future<void> show(BuildContext context, Offset at) async {
    final pick = await showAppMenu<String>(
      ...
      items: [
        AppMenuItem(
          value: 'merge',
          label: context.t.flightdeck.projectsRail.mergeToParent,
        ...
        AppMenuItem(
          value: 'update',
          label: context.t.flightdeck.projectsRail.updateFromParent,
        ...
        AppMenuItem(
          value: 'fork',
          label: context.t.flightdeck.projectsRail.forkWorktree,
          icon: Icons.call_split,
        ),
        AppMenuItem(
          value: 'copy',
          label: context.t.flightdeck.projectsRail.copyBranch,
          icon: Icons.content_copy,
        ),
        AppMenuItem(
          value: 'remove',
          label: context.t.flightdeck.projectsRail.remove,
...
class _WorkspaceMenu {
  ...
  /// Id do workspace (`projectId`) — copiável pra usar na CLI `flightdeck`
      ...
      items: [
        ...
        if (canCreateWorktree) ...[
          gitMenuItem(
            roots,
            'sync',
            context.t.flightdeck.projectsRail.sync,
            Icons.sync,
          ),
          gitMenuItem(
            roots,
            'pull',
            context.t.flightdeck.projectsRail.pull,
            Icons.arrow_downward,
          ),
          gitMenuItem(
            roots,
            'push',
            context.t.flightdeck.projectsRail.push,
            Icons.arrow_upward,
          ),
          gitMenuItem(
            roots,
            'worktree',
            context.t.flightdeck.projectsRail.createWorktree,
            Icons.call_split,
          ),
        ],
        if (moveTargets.isNotEmpty)
          AppMenuItem(
            value: 'realm', // nunca devolvido — só os filhos
            label: context.t.flightdeck.projectsRail.moveToRealm,
            icon: Icons.public,
            children: [
              for (final t in moveTargets)
                AppMenuItem(
        ...
        AppMenuItem(
          value: 'copy-id',
          label: context.t.flightdeck.projectsRail.copyWorkspaceId,
          icon: Icons.content_copy,
        ),
        ...
        if (roots.any((r) => r.git != null))
          gitMenuItem(
            roots,
            'copy-branch',
            context.t.flightdeck.projectsRail.copyBranch,
            Icons.content_copy,
          ),
        AppMenuItem(
          value: 'config',
          label: context.t.flightdeck.projectsRail.settings,
          icon: Icons.settings_outlined,
        ),
        AppMenuItem(
          value: 'delete',
          label: context.t.flightdeck.projectsRail.close,
          icon: Icons.close,
          danger: true,
        ),
      ],
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Padding(
        ...
        child: Text(
          context.t.flightdeck.projectsRail.noWorkspaces,
          textAlign: TextAlign.center,
  ...
  Future<void> _open(BuildContext context) async {
    final pick = await showAppMenu<String>(
      ...
      items: [
        ...
        AppMenuItem(
          value: '__new__',
          label: context.t.flightdeck.projectsRail.newRealm,
          icon: Icons.add,
        ),
        AppMenuItem(
          value: '__manage__',
          label: context.t.flightdeck.projectsRail.manageRealms,
          icon: Icons.tune,
        ),
      ],
    );
