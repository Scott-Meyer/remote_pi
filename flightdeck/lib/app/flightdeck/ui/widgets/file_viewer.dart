...
import 'package:flightdeck/app/flightdeck/ui/widgets/agent_markdown.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/code_editor.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/file_find_bar.dart';
...
import 'package:flightdeck/app/flightdeck/ui/widgets/file_path_breadcrumb.dart';
...
import 'package:flightdeck/app/core/ui/widgets/code_editing_controller.dart';
import 'package:flightdeck/app/core/ui/widgets/code_highlight.dart';
import 'package:flightdeck/app/core/ui/widgets/selectable_scroll.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/media_view.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/web_markdown_preview.dart';
...
class _FileViewerState extends State<FileViewer> {
  ...
  void _ensureAndBindScm(CodeEditingController controller) {
    final vm = _vm ?? context.read<FlightDeckViewModel>();
    _vm = vm;
  ...
  String get _workspaceRoot =>
      context.read<FlightDeckViewModel>().projectRootOf(
    ...
    final Widget body = widget.session.loading
        ...
        : switch (widget.session.view) {
            ...
            FileViewUnsupported() => Center(
              child: Text(
                context.t.flightdeck.fileViewer.cantOpen,
        ...
        children: [
          ...
          _Toolbar(
            leading: FilePathBreadcrumb(
              path: context.read<FlightDeckViewModel>().displayPath(
                widget.session.projectId,
                widget.session.path,
              ),
      ...
      child: Row(
        children: [
          ...
          if (hasPreview) ...[
            ...
            _Segmented(
              leftLabel: context.t.flightdeck.fileViewer.preview,
              rightLabel: context.t.flightdeck.fileViewer.source,
          ...
          child: isSvg
              ...
              : Image.file(
                  ...
                  errorBuilder: (context, error, stack) => Text(
                    context.t.flightdeck.fileViewer.couldNotLoadImage,
                    style: context.typo.body.copyWith(color: colors.text3),
                  ),
                ),
        ),
