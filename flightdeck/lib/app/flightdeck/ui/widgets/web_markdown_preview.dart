...
import 'package:flightdeck/app/core/ui/widgets/unzoomed_native_view.dart';
...
class _WebMarkdownPreviewState extends State<WebMarkdownPreview> {
  ...
  Future<void> _pushTheme(Map<String, String> vars) async {
    ...
    await web.evaluateJavascript(
      source: 'window.__flightdeck.setTheme(${jsonEncode(vars)});',
    );
  }
  ...
  Future<void> _push() async {
    ...
    await web.evaluateJavascript(
      source:
          'window.__flightdeck.setTheme($theme);'
          'window.__flightdeck.setContent($text, $dir);',
    );
  }
