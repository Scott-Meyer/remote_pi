...
import 'package:flightdeck/app/flightdeck/ui/widgets/commit_message_dialog.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/confirm_dialog.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/git_history_panel.dart';
import 'package:flightdeck/app/flightdeck/ui/widgets/panel_resize_handle.dart';
...
import 'package:flightdeck/app/core/ui/file_operation_error_message.dart';
import 'package:flightdeck/app/core/domain/result.dart';
import 'package:flightdeck/app/core/ui/file_icons/file_icons.dart';
import 'package:flightdeck/app/core/ui/settings_controller.dart';
import 'package:flightdeck/app/core/ui/themes/themes.dart';
import 'package:flightdeck/app/core/ui/widgets/context_menu_gesture.dart';
...
class _FileTreePanelState extends State<FileTreePanel> {
  ...
  Future<void> _discardOne(String absPath) async {
    ...
    final tr = context.t.flightdeck.fileTreePanel;
  ...
  Future<void> _commitStaged() async {
    ...
    if (message.isEmpty) {
      setState(
        () => _commitError = context.t.flightdeck.fileTreePanel.enterCommitMessage,
      );
      return;
    }
    if (widget.onCommitStaged == null) {
      setState(
        () => _commitError = context.t.flightdeck.fileTreePanel.commitUnavailable,
      );
      return;
    }
    setState(() {
  ...
  Future<void> _showGitError(String message) => showConfirmDialog(
    context,
    title: context.t.flightdeck.fileTreePanel.gitErrorTitle,
    message: message,
  ...
  Future<void> _requestPaste(String targetDir) async {
    ...
    r.fold(
      ...
      (e) => showInfoDialog(
        context,
        title: context.t.flightdeck.fileTreePanel.couldNotPasteTitle,
        message: fileOperationErrorMessage(context, e),
      ),
    );
  }
      ...
      child: Column(
        children: [
            ...
            child: Row(
              children: [
                _HeaderIcon(
                  ...
                  tooltip: context.t.flightdeck.fileTreePanel.filesTooltip,
                ...
                if (hasSearch)
                  _HeaderIcon(
                    icon: Icons.search,
                    tooltip: context.t.flightdeck.fileTreePanel.searchTooltip,
                    selected: searchMode,
                ...
                if (widget.isGitRepo)
                  _HeaderIcon(
                    ...
                    tooltip:
                        context.t.flightdeck.fileTreePanel.sourceControlTooltip,
                    selected: scMode,
                    onTap: () =>
                ...
                if (hasDatabase)
                  _HeaderIcon(
                    ...
                    icon: Icons.storage,
                    tooltip: context.t.flightdeck.fileTreePanel.databaseTooltip,
                    selected: dbMode,
                ...
                if (hasGallery)
                  _HeaderIcon(
                    ...
                    tooltip: context.t.flightdeck.fileTreePanel.galleryTooltip,
          ...
          if (widget.rootPath.isNotEmpty && tab == _RightPaneTab.files)
            _PanelHeader(
              title: context.t.flightdeck.fileTreePanel.sectionFiles,
              actions: [
                ...
                if (_headerCreateTarget()?.isNotEmpty ?? false) ...[
                  _PanelHeaderAction(
                    ...
                    tooltip: context.t.flightdeck.fileTreePanel.newFile,
                    onTap: () => _headerCreate(false),
                  ),
                  _PanelHeaderAction(
                    icon: Icons.create_new_folder_outlined,
                    tooltip: context.t.flightdeck.fileTreePanel.newFolder,
                    onTap: () => _headerCreate(true),
                  ),
                ],
                _PanelHeaderAction(
                  icon: Icons.unfold_less,
                  tooltip: context.t.flightdeck.fileTreePanel.collapseAll,
                  onTap: () => setState(() => _collapseGen++),
                ),
                _PanelHeaderAction(
                  icon: Icons.refresh,
                  tooltip: context.t.flightdeck.fileTreePanel.refreshTooltip,
                  onTap: () => setState(() => _localRefresh++),
                ),
              ],
            ),
          if (widget.rootPath.isNotEmpty && galleryMode)
            _PanelHeader(title: context.t.flightdeck.fileTreePanel.sectionGallery),
          if (widget.rootPath.isNotEmpty && scMode)
            _PanelHeader(
              title: context.t.flightdeck.fileTreePanel.sectionSourceControl,
              actions: [
                _PanelHeaderAction(
                  key: const ValueKey('source-control-changes-tab'),
                  icon: Icons.edit_note_outlined,
                  tooltip: context.t.flightdeck.fileTreePanel.changes,
                ...
                _PanelHeaderAction(
                  ...
                  icon: Icons.history,
                  tooltip: context.t.flightdeck.fileTreePanel.history,
          ...
          Expanded(
            child: widget.rootPath.isEmpty
                ? Center(
                    child: Text(
                      context.t.flightdeck.fileTreePanel.noFolderMessage,
...
class _CommitComposer extends StatelessWidget {
  ...
  Widget _commitPicker(BuildContext context) {
    ...
    final label = amendSubject == null
        ? context.t.flightdeck.fileTreePanel.lastCommit
...
class _RowState extends State<_Row> {
  ...
  String get _fileExplorerLabel {
    if (Platform.isMacOS) return context.t.flightdeck.fileTreePanel.openInFinder;
    if (Platform.isWindows) {
      return context.t.flightdeck.fileTreePanel.openInExplorer;
    }
    return context.t.flightdeck.fileTreePanel.openInFileManager;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final Widget label = widget.renaming
        ? _NameField(
            ...
            onSubmit: (name) async {
              final renameFailed = context.t.flightdeck.fileTreePanel.renameFailed;
...
class _ChangedTree extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (stagedPaths.isEmpty && unstagedPaths.isEmpty) {
      return Center(
        child: Text(
          context.t.flightdeck.fileTreePanel.noChanges,
        ...
        Padding(
          ...
          child: Row(
            children: [
              Text(
                staged
                    ? context.t.flightdeck.fileTreePanel.stagedChangesHeader(
                        count: files.length,
                      )
                    : context.t.flightdeck.fileTreePanel.changesHeader(
                        count: files.length,
                      ),
                style: context.typo.label.copyWith(color: context.colors.text3),
              ),
              ...
              _PanelHeaderAction(
                ...
                tooltip: viewAsTree
                    ? context.t.flightdeck.fileTreePanel.viewAsList
                    : context.t.flightdeck.fileTreePanel.viewAsTree,
                onTap: onToggleViewMode,
              ),
              AppTooltip(
                message: context.t.flightdeck.fileTreePanel.discardAllChanges,
                child: HoverTap(
                  key: ValueKey(
              ...
              AppTooltip(
                message: staged
                    ? context.t.flightdeck.fileTreePanel.unstageAllChanges
                    : context.t.flightdeck.fileTreePanel.stageAllChanges,
                child: HoverTap(
                  key: ValueKey(
            ...
            children: [
              ...
              if (_hovered) ...[
                Positioned(
                  ...
                  child: AppTooltip(
                    message:
                        context.t.flightdeck.fileTreePanel.discardFolderChanges,
                    child: HoverTap(
                ...
                Positioned(
                  ...
                  child: AppTooltip(
                    message: widget.staged
                        ? context.t.flightdeck.fileTreePanel.unstageFolderChanges
                        : context.t.flightdeck.fileTreePanel.stageFolderChanges,
                    child: HoverTap(
          ...
          for (final file in files)
            _ChangedRow(
              ...
              trailingTooltip: widget.staged
                  ? context.t.flightdeck.fileTreePanel.unstage
                  : context.t.flightdeck.fileTreePanel.stageChanges,
              ...
              children: [
                ...
                if (_hovered && widget.onOpenFileTap != null)
                  Positioned(
                    ...
                    bottom: 1,
                    child: AppTooltip(
                      message: context.t.flightdeck.fileTreePanel.open,
                      child: HoverTap(
                ...
                if (_hovered && widget.onDiscardTap != null)
                  Positioned(
                    ...
                    bottom: 1,
                    child: AppTooltip(
                      message: context.t.flightdeck.fileTreePanel.discardChanges,
                      child: HoverTap(
