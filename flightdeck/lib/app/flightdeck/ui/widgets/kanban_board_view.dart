...
class _KanbanBoardViewState extends State<KanbanBoardView> {
  ...
  Future<void> _apply(String content) async {
    ...
    _showError(context.t.flightdeck.kanbanView.couldNotSave);
  }
  ...
  Future<void> _addCard(int column) async {
    final title = context.t.flightdeck.kanbanView.newCardTitle;
  ...
  Future<void> _showCardMenu(
    ...
    final tr = context.t.flightdeck.kanbanView;
                    ...
                    Padding(
                      ...
                      child: Tooltip(
                        tooltip: TooltipContainer(
                          child: Text(context.t.flightdeck.kanbanView.emptyColumn),
                        ).call,
                        child: Icon(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!card.recognized) ...[
                          ...
                          Text(
                            context.t.flightdeck.kanbanView.unrecognizedBlock,
                            style: typo.mono.copyWith(
                              fontSize: 9.5,
                              color: colors.text4,
                            ),
...
class _AddCardButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Tooltip(
      tooltip: TooltipContainer(
        child: Text(context.t.flightdeck.kanbanView.newCard),
      ).call,
      child: HoverTap(
        onTap: onTap,
        borderRadius: BorderRadius.circular(5),
