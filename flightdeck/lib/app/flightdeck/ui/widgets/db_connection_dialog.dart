...
class _DbConnectionDialogState extends State<DbConnectionDialog> {
  ...
  Future<void> _pickSshKey() async {
    ...
    final result = await FilePicker.platform.pickFiles(
      dialogTitle:
          context.t.flightdeck.dbConnectionDialog.choosePrivateKeyDialogTitle,
  ...
  Future<void> _pickFile() async {
    ...
    final result = await FilePicker.platform.pickFiles(
      dialogTitle: context.t.flightdeck.dbConnectionDialog.chooseFileTitle,
  ...
  Future<void> _test() async {
    ...
    if (built == null) {
      setState(() {
        _testing = false;
        _testOk = false;
        _testMessage = context.t.flightdeck.dbConnectionDialog.invalidUrl;
      });
      return;
    }
  ...
  Widget _fileField() {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.t.flightdeck.dbConnectionDialog.file,
  ...
  Widget _uriField(AppColors colors, AppTypography typo) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            context.t.flightdeck.dbConnectionDialog.connectionString,
            style: typo.label.copyWith(fontSize: 11, color: colors.text3),
          ),
          const SizedBox(height: 4),
          ...
          if (invalid) ...[
            const SizedBox(height: 4),
            Text(
              context.t.flightdeck.dbConnectionDialog.invalidUrl,
        ...
        child: HoverTap(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              Text(
                context.t.flightdeck.dbConnectionDialog.sshTunnel,
                style: typo.label.copyWith(fontSize: 12, color: colors.text2),
              ),
              const Spacer(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _field(context.t.flightdeck.dbConnectionDialog.sshHost, _sshHost),
          Row(
            children: [
              Expanded(
                child: _field(
                  context.t.flightdeck.dbConnectionDialog.sshPort,
                  _sshPort,
              ...
              Expanded(
                child: _field(
                  context.t.flightdeck.dbConnectionDialog.sshUser,
                  _sshUser,
                ),
              ),
            ],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  context.t.flightdeck.dbConnectionDialog.privateKey,
                  style: typo.label.copyWith(fontSize: 11, color: colors.text3),
                ),
                const SizedBox(height: 4),
                HoverTap(
          ...
          if (_sshKeyEncrypted) ...[
            _field(
              context.t.flightdeck.dbConnectionDialog.keyPassphrase,
              _sshPassphrase,
              obscure: true,
            ...
            _switchRow(
              context.t.flightdeck.dbConnectionDialog.savePassphrase,
              _saveSshPassphrase,
  ...
  Widget _dialog(AppColors colors, AppTypography typo) {
    final tr = context.t.flightdeck.dbConnectionDialog;
    return AlertDialog(
      title: Row(
        children: [
        ...
        child: Column(
          ...
          children: [
            ...
            if (_engine == DbEngine.sqlite)
              ...
              if (_savePassword) ...[
                _field(
                  context.t.flightdeck.dbConnectionDialog.password,
                  _pass,
                  obscure: true,
                ...
                if (widget.viewModel.isRemoteWorkspace)
                  Padding(
                    ...
                    child: Text(
                      context.t.flightdeck.dbConnectionDialog.passwordOnHost,
