...
import 'package:flightdeck/app/core/ui/widgets/markdown_frontmatter.dart';
import 'package:shadcn_flutter/shadcn_flutter.dart';

/// Renderiza o Markdown (GFM + code) da resposta do agente, com a identidade
/// visual do FlightDeck. Tolerante a markdown parcial (serve pro streaming).
class AgentMarkdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // FlightDeck (senão o pacote usa o ThemeData() claro → títulos escuros). A
