...
class _DbQueryViewState extends State<DbQueryView> {
  ...
  Future<bool> _save() async {
    ...
    if (widget.session.scratch) {
      ...
      final result = await context.read<FlightDeckViewModel>().saveScratchAs(
        widget.session.id,
        name,
        content,
      );
  ...
  Future<String?> _promptName() {
    ...
    return showDialog<String>(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: Text(
            context.t.flightdeck.dbQueryView.saveQueryAs,
  ...
  void _showSaveError(String message) {
    showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        title: Text(
          context.t.flightdeck.dbQueryView.couldNotSave,
          style: context.typo.title.copyWith(
            fontSize: 15,
    ...
    final picked = await showAppMenu<String>(
      ...
      items: [
        ...
        if (conns.isEmpty)
          AppMenuItem(
            value: '',
            label: context.t.flightdeck.dbQueryView.noSqlConnections,
            enabled: false,
          ),
      ],
    );
          ...
          Builder(
            builder: (anchor) => HoverTap(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    _connName ?? context.t.flightdeck.dbQueryView.selectDatabase,
              ...
              children: [
                ...
                ListenableBuilder(
                  ...
                  builder: (context, _) {
                    ...
                    final tr = context.t.flightdeck.dbQueryView;
                    return Text(
                      _running
                          ? tr.running
                          : hasSel
    ...
    return HoverTap(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            _copied
                ? context.t.flightdeck.dbQueryView.copied
                : context.t.flightdeck.dbQueryView.copy,
            style: context.typo.label.copyWith(
              fontSize: 10.5,
              color: colors.text3,
            ),
