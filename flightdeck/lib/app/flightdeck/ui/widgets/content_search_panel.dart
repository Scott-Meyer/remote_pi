...
class _ContentSearchPanelState extends State<ContentSearchPanel> {
  ...
  Widget _header(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Text(
            context.t.flightdeck.contentSearch.sectionSearch,
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            child: CallbackShortcuts(
              ...
              child: TextField(
                ...
                focusNode: _focus,
                placeholder: Text(
                  context.t.flightdeck.contentSearch.searchInFiles,
          ...
          _OptionToggle(
            label: 'Aa',
            tooltip: context.t.flightdeck.contentSearch.matchCase,
            active: _caseSensitive,
            onTap: () => _toggle(() => _caseSensitive = !_caseSensitive),
          ),
          _OptionToggle(
            label: 'ab',
            tooltip: context.t.flightdeck.contentSearch.wholeWord,
            active: _wholeWord,
            underline: true,
          ...
          _OptionToggle(
            label: '.*',
            tooltip: context.t.flightdeck.contentSearch.useRegex,
            active: _regex,
  ...
  Widget _resultsList(BuildContext context) {
    ...
    if (_results.isEmpty) {
      ...
      if (_invalidRegex) {
        message = context.t.flightdeck.contentSearch.invalidRegex;
      } else if (!hasQuery) {
        message = context.t.flightdeck.contentSearch.typeToSearch;
      } else if (_searching) {
        message = context.t.flightdeck.contentSearch.searching;
      } else {
        message = context.t.flightdeck.contentSearch.noResults;
      }
      return Padding(
