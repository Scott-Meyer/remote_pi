import 'package:flightdeck/app/core/terminal/ghostty_font_family.dart';
...
import 'package:flightdeck/app/core/terminal/terminal_font_weight.dart';
import 'package:flightdeck/app/core/terminal/terminal_zoom.dart';
...
class AdaptiveTerminalPane extends StatelessWidget {
  ...
  final FlightDeckTerminalController terminal;
  final bool active;
...
final class _FlightDeckPasteIntent extends Intent {
  const _FlightDeckPasteIntent();
}
      ...
      child: TickerMode(
        ...
        child: Actions(
          actions: <Type, Action<Intent>>{
            _FlightDeckPasteIntent: CallbackAction<_FlightDeckPasteIntent>(
              onInvoke: (_) {
                onPaste?.call();
                return null;
              },
