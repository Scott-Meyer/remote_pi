...
import 'package:flightdeck/app/flightdeck/ui/remote/remote_folder_picker.dart';
...
String _labelOf(FlightDeckViewModel vm, String wsId) {
...
Project? _remoteWorkspace(FlightDeckViewModel vm, String wsId) {
  for (final p in vm.remoteWorkspaces) {
...
RemoteHost? _hostById(FlightDeckViewModel vm, String hostId) {
...
Future<void> newWorkspaceMenu(
  ...
  final tr = context.t.flightdeck.remoteHost;
...
Future<void> handleRemoteWorkspaceAction(
  ...
  final page = context.t.flightdeck.flightdeckPage;
