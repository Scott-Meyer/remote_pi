...
import 'package:flightdeck/app/core/ui/menu/app_menu_bar.dart';
...
import 'package:flightdeck/app/core/ui/clamping_scroll_behavior.dart';
import 'package:flightdeck/app/core/ui/widgets/devtools_inspector.dart';
import 'package:flightdeck/app/core/ui/overlay/app_popover_handler.dart';
...
class AppRoot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final app = ShadcnApp.router(
      ...
      builder: (context, child) {
        ...
        // tokens bespoke e os instala via FlightDeckTheme — alimenta
  ...
  /// pelo `FlightDeckPage`). Fica aqui (não no shell) pra disparar mesmo quando o
