...
import 'package:flightdeck/app/settings/data/daemon/supervisor_client_impl.dart';
import 'package:flightdeck/app/settings/data/relay/relay_gateway_impl.dart';
import 'package:flightdeck/app/settings/domain/contracts/cron_gateway.dart';
import 'package:flightdeck/app/settings/domain/contracts/daemon_supervisor.dart';
import 'package:flightdeck/app/settings/domain/contracts/relay_gateway.dart';
...
import 'package:flightdeck/app/settings/ui/settings_page.dart';
  ...
  register: (c) {
    ...
    c
      ...
      ..route(
        ...
        provide: (s) => s
          // Hosts remotos (plano 58): singleton do flightdeck_module (já carregado
          // — flightdeck é a rota inicial). Observado aqui pela aba "Remote hosts"
          ...
          // flightdeck_module (rota base, nunca sai da pilha).
