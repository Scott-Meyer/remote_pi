...
import 'package:flightdeck/app/flightdeck/data/remote/remote_host_connector.dart'
    show RemoteHostPhase;
import 'package:flightdeck/app/flightdeck/domain/entities/remote_host.dart';
import 'package:flightdeck/app/flightdeck/ui/remote/add_remote_host_dialog.dart';
...
import 'package:flightdeck/app/core/domain/entities/setup_check.dart';
...
import 'package:flightdeck/app/core/domain/services/automation_model_catalog.dart';
import 'package:flightdeck/app/core/ui/automation_controller.dart';
import 'package:flightdeck/app/core/ui/automation_error_message.dart';
import 'package:flightdeck/app/core/ui/widgets/macos_notification_instructions_dialog.dart';
import 'package:flightdeck/app/settings/domain/cron_schedule.dart';
import 'package:flightdeck/app/core/data/diagnostics/diagnostics_log.dart';
import 'package:flightdeck/app/core/ui/widgets/error_report_dialog.dart';
...
import 'package:flightdeck/app/core/utils/native_folder_picker.dart';
...
import 'package:flightdeck/app/core/terminal/terminal_controller.dart'
    show terminalEngineIsSelectable;
import 'package:flightdeck/app/settings/domain/entities/cron_job.dart';
import 'package:flightdeck/app/settings/domain/entities/daemon_info.dart';
import 'package:flightdeck/app/settings/domain/entities/paired_device.dart';
import 'package:flightdeck/app/core/ui/widgets/app_menu.dart';
import 'package:flightdeck/app/core/ui/widgets/code_highlight.dart';
import 'package:flightdeck/app/core/ui/widgets/window_controls.dart';
import 'package:flightdeck/app/settings/ui/connectivity_viewmodel.dart';
import 'package:flightdeck/app/settings/ui/cron_viewmodel.dart';
import 'package:flightdeck/app/settings/ui/daemons_viewmodel.dart';
import 'package:flightdeck/app/settings/ui/notifications_viewmodel.dart';
import 'package:flightdeck/app/settings/ui/pairing_dialog.dart';
import 'package:flightdeck/app/settings/ui/revoke_dialog.dart';
import 'package:flightdeck/app/settings/ui/settings_env_gate.dart';
import 'package:flightdeck/app/settings/ui/shortcut_catalog.dart';
import 'package:flightdeck/app/core/ui/menu/workspace_menu_bridge.dart';
import 'package:flightdeck/app/core/ui/settings_controller.dart';
import 'package:flightdeck/app/core/ui/theme_store_error_message.dart';
...
import 'package:flightdeck/app/core/ui/font_catalog.dart';
import 'package:flightdeck/app/core/ui/widgets/hover_tap.dart';
import 'package:flightdeck/app/settings/ui/font_picker_dialog.dart';
import 'package:flightdeck/i18n/strings.g.dart';
import 'package:flightdeck/app/core/routes.dart';
import 'package:flutter_modular/flutter_modular.dart';
import 'package:package_info_plus/package_info_plus.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:flightdeck/app/core/ui/widgets/app_tooltip.dart';
...
/// Rodapé do nav: "FlightDeck `version`" no canto inferior esquerdo, pra
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: Text(
          _version == null ? 'FlightDeck' : 'FlightDeck $_version',
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              // Agent / FlightDeck / Updates: motor-local + self-update = desktop.
              ...
              if (!isMobilePlatform) ...[
                ...
                _Section(
                  ...
                  child: _Card(
                    children: [
                      _Row(
                        title: tr.showFlightDeckTitle,
                        description: tr.showFlightDeckDesc,
                        trailing: Switch(
                          value: s.showFlightDeck,
                          onChanged: controller.setShowFlightDeck,
                        ),
                      ),
                      _Row(
...
/// Seção "Storage": mostra onde o FlightDeck guarda seu estado, deixa o usuário
...
class _DiagnosticsSection extends StatelessWidget {
  ...
  /// do FlightDeck são montados com `/`, a conversão precisa acontecer aqui, na
...
class _StorageSectionState extends State<_StorageSection> {
  ...
  Future<void> _changeFolder() async {
    ...
    final picked = await NativeFolderPicker.pick(
      ...
      initialDirectory: _root, // abre na pasta atual do FlightDeck
    );
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              // Ajuda: a pessoa precisa saber que o host tem que ter o FlightDeck
              // (desktop) ou o flightdeck-server instalado + a chave autorizada.
              _Section(
                label: tr.helpTitle,
                child: _Card(
                  children: [
...
class _ThemeDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AppMenuItem<String> itemFor(FlightDeckThemeSpec theme, {required bool own}) =>
        AppMenuItem(
          value: theme.id,
          label: theme.name,
...
/// mágica (FlightDeck não instala servidores; só usa o que está na máquina).
