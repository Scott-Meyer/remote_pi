...
import 'package:flightdeck/app/core/domain/exceptions/relay_error.dart';
import 'package:flightdeck/app/core/domain/result.dart';

/// Fronteira de conectividade do FlightDeck: lê/define o relay global e gerencia os
/// aparelhos pareados.
///
/// Tudo é delegado ao binário `remote-pi` (shell-out) e ao config compartilhado
/// `~/.pi/remote/config.json` — o FlightDeck **nunca** implementa crypto nem fala o
