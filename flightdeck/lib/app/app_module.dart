import 'package:flightdeck/app/flightdeck/flightdeck_module.dart';
import 'package:flightdeck/app/core/core_module.dart';
import 'package:flightdeck/app/core/data/terminal/terminal_profile_resolver_impl.dart';
import 'package:flightdeck/app/core/env.dart';
import 'package:flightdeck/app/core/ui/window_activity_controller.dart';
import 'package:flightdeck/app/settings/settings_module.dart';
...
///
/// `Future` porque o `flightdeck` faz bootstrap async (abre os próprios stores JSON).
...
Future<Module> buildAppModule({
  ...
  final flightdeck = await buildFlightDeckModule(windowActivity: windowActivity);
