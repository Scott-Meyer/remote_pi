...
class AppSettings {
  ...
  /// Mostra o workspace de sistema "FlightDeck" (terminal-only, sem pasta) fixo no
  ...
  final bool showFlightDeck;

  /// Inicia o FlightDeck junto com o login do sistema (item de login do SO).
  ...
  AppSettings copyWith({
    ...
    return AppSettings(
      ...
      showFlightDeck: showFlightDeck ?? this.showFlightDeck,
  ...
  factory AppSettings.fromJson(Map<dynamic, dynamic> json) {
    ...
    return AppSettings(
      ...
      showFlightDeck: json['showFlightDeck'] as bool? ?? true,
