...
/// Persiste PIDs de processos filhos sem misturar instâncias do FlightDeck.
///
/// Cada categoria grava um arquivo por PID proprietário:
///
/// ```text
/// ~/.pi/flightdeck/process-pids/<category>/<ownerPid>.pids
/// ```
///
...
/// outros FlightDecks ainda vivos são preservados.
class OwnedProcessRegistry {
  ...
  static String _defaultRootPath() {
    ...
    return '$home${Platform.pathSeparator}.pi${Platform.pathSeparator}'
        'flightdeck${Platform.pathSeparator}process-pids';
  }
