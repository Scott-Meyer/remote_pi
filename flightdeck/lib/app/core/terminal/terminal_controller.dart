...
import 'package:flightdeck/app/core/terminal/ghostty_sgr_weight_normalizer.dart';
import 'package:flightdeck/app/core/terminal/xterm/xterm.dart' as xterm;
...
sealed class FlightDeckTerminalController {
  ...
  /// **view** (`FlightDeckTerminal`), fora do alcance da sessão — lá devolve vazio.
  String selectedText();

  void dispose();
}

final class XtermTerminalController implements FlightDeckTerminalController {
  ...
  /// A seleção do xterm pertence ao controller da view (`FlightDeckTerminal`), que
...
final class GhosttyTerminalController implements FlightDeckTerminalController {
...
/// iOS. Com o pin casado (`flightdeck-pin-flterm-ios-recover`: flterm 0.0.5 +
...
FlightDeckTerminalController createTerminalController(
