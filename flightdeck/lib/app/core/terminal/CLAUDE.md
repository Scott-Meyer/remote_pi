...
- **`flightdeck_terminal*.dart`** — view/render próprios (cache de `ui.Picture`
...
O PTY (nativo, C/FFI) também é nosso: **`plugins/flightdeck_pty/`** — absorvido
2026-07-19 do fork `jacobaraujo7/kyroon_pty` v1.0.6 (upstream
cesarmod2017/kyroon_pty, MIT preservado), renomeado `kyroon_pty`→`flightdeck_pty`
