// Fork do `TerminalView` do xterm (src/terminal_view.dart) pro flightdeck. Cópia
...
// [FlightDeckTerminalRender] (com cache de Picture por linha) em vez do
// `RenderTerminal` original — ver flightdeck_terminal_render.dart.
//
...
import 'package:flightdeck/app/core/terminal/xterm/src/core/buffer/cell_offset.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/core/input/keys.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/terminal.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/controller.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/cursor_type.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/custom_text_edit.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/input_map.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/keyboard_listener.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/keyboard_visibility.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/scroll_handler.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/shortcut/actions.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/shortcut/shortcuts.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/terminal_text_style.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/terminal_theme.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/themes.dart';

import 'flightdeck_terminal_gesture.dart';
import 'flightdeck_terminal_render.dart';

class FlightDeckTerminal extends StatefulWidget {
  const FlightDeckTerminal(
    this.terminal, {
    super.key,
    this.controller,
  ...
  @override
  State<FlightDeckTerminal> createState() => FlightDeckTerminalState();
}

class FlightDeckTerminalState extends State<FlightDeckTerminal> {
  ...
  FlightDeckTerminalRender get renderTerminal =>
      _viewportKey.currentContext!.findRenderObject() as FlightDeckTerminalRender;
  ...
  @override
  void didUpdateWidget(FlightDeckTerminal oldWidget) {
  ...
  Widget build(BuildContext context) {
    Widget child = Scrollable(
      ...
      viewportBuilder: (context, offset) {
        return _FlightDeckTerminalLeaf(
          key: _viewportKey,
    ...
    child = FlightDeckTerminalGestureHandler(
      terminalView: this,
...
class _FlightDeckTerminalLeaf extends LeafRenderObjectWidget {
  const _FlightDeckTerminalLeaf({
    super.key,
  ...
  @override
  FlightDeckTerminalRender createRenderObject(BuildContext context) {
    return FlightDeckTerminalRender(
      terminal: terminal,
  ...
  void updateRenderObject(
    ...
    FlightDeckTerminalRender renderObject,
  ) {
    renderObject
      ..terminal = terminal
      ..controller = controller
