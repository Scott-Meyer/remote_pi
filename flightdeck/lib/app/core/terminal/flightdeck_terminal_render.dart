...
// flightdeck pra ganharmos controle do *renderer* sem manter um fork do pacote
...
//
// Reusamos o `FlightDeckTerminalPainter` do xterm (que já tem cache de parágrafo, glifos
...
import 'package:flightdeck/app/core/terminal/xterm/src/core/buffer/range.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/core/buffer/segment.dart';
...
import 'package:flightdeck/app/core/terminal/xterm/src/ui/selection_mode.dart';
import 'package:flightdeck/app/core/terminal/xterm/src/ui/terminal_size.dart';
...
import 'flightdeck_terminal_painter.dart';

typedef EditableRectCallback = void Function(Rect rect, Rect caretRect);

class FlightDeckTerminalRender extends RenderBox
    with RelayoutWhenSystemFontsChangeMixin {
  FlightDeckTerminalRender({
    ...
    String? composingText,
       ...
       _painter = FlightDeckTerminalPainter(
         theme: theme,
         textStyle: textStyle,
  ...
  final FlightDeckTerminalPainter _painter;
  ...
  /// `FlightDeckTerminalPainter` do xterm, então herda cache de parágrafo e glifos
