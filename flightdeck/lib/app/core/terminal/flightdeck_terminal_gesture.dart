...
// xterm — precisamos do nosso [FlightDeckTerminalState] pra alcançar o
// [FlightDeckTerminalRender]. A lógica (tap/drag/double-tap → seleção; encaminhar
...
import 'package:flightdeck/app/core/terminal/xterm/src/ui/gesture/gesture_detector.dart';

import 'flightdeck_terminal.dart';
import 'flightdeck_terminal_render.dart';

class FlightDeckTerminalGestureHandler extends StatefulWidget {
  const FlightDeckTerminalGestureHandler({
    super.key,
  ...
  final FlightDeckTerminalState terminalView;
  ...
  @override
  State<FlightDeckTerminalGestureHandler> createState() =>
      _FlightDeckTerminalGestureHandlerState();
}

class _FlightDeckTerminalGestureHandlerState
    extends State<FlightDeckTerminalGestureHandler> {
  FlightDeckTerminalState get terminalView => widget.terminalView;

  FlightDeckTerminalRender get renderTerminal => terminalView.renderTerminal;
  ...
  void onTapDown(TapDownDetails details) {
    ...
    // The FlightDeckTerminal depends on it to bring the terminal into focus.
    _tapDown(
      widget.onTapDown,
      details,
