...
import 'package:flightdeck/app/core/ui/themes/color_contrast.dart';
import 'package:flightdeck/app/core/ui/themes/app_typography.dart';
...
FlightDeckTokens buildTokens({
  required Brightness brightness,
  AppSettings settings = const AppSettings(),
  FlightDeckThemeSpec? theme,
}) {
  final variant = (theme ?? flightdeckDefaultTheme).variantFor(brightness);
...
ThemeData buildTheme({
  ...
  final colors = (theme ?? flightdeckDefaultTheme).variantFor(brightness).ui;
  ...
  // shadcn — assim todo componente shadcn herda a tipografia do FlightDeck (o
...
/// Mapeia os 19 tokens do FlightDeck nos slots semânticos do `ColorScheme` do
