...
/// ```
///
/// Os tokens vêm do [FlightDeckTheme] (InheritedWidget instalado pela raiz). Se um
...
extension AppThemeX on BuildContext {
  AppColors get colors => FlightDeckTheme.maybeOf(this)?.colors ?? AppColors.dark;

  AppTypography get typo => FlightDeckTheme.maybeOf(this)?.typo ?? _fallbackTypo;

  SyntaxColors get syntax =>
      FlightDeckTheme.maybeOf(this)?.syntax ?? SyntaxColors.dark;
  ...
  TerminalTheme get terminalTheme =>
      FlightDeckTheme.maybeOf(this)?.terminal ??
      flightdeckTerminalThemeFor(
