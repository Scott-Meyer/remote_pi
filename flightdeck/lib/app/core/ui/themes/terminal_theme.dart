...
const TerminalTheme flightdeckTerminalThemeDark = TerminalTheme(
...
const TerminalTheme flightdeckTerminalThemeLight = TerminalTheme(
  cursor: Color(0xFF2F6FF0), // accent
...
TerminalTheme flightdeckTerminalThemeFor(Brightness brightness) =>
    brightness == Brightness.dark
    ? flightdeckTerminalThemeDark
    : flightdeckTerminalThemeLight;
