...
import 'package:flightdeck/app/core/data/setup/launch_at_startup_service.dart';
import 'package:flightdeck/app/core/data/setup/sound_library.dart';
...
import 'package:flightdeck/app/core/ui/themes/theme_registry.dart';
...
class SettingsController extends ChangeNotifier {
  ...
  List<FlightDeckThemeSpec> _customThemes = const [];

  /// Catálogo completo: built-in primeiro, importados depois.
  List<FlightDeckThemeSpec> get availableThemes => [
    ...builtInThemes,
    ..._customThemes,
  ];
  ...
  Future<Result<FlightDeckThemeSpec, ThemeStoreError>> importTheme(
    File file,
  ) async {
  ...
  void setShowFlightDeck(bool value) =>
      _apply(_settings.copyWith(showFlightDeck: value));
  ...
  /// a fonte de verdade em runtime é a `FlightDeckViewModel` — aqui só grava.
