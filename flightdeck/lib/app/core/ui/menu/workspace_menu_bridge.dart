...
/// O `FlightDeckPage` publica se há um workspace ativo + os callbacks que abrem uma
...
class WorkspaceMenuBridge extends ChangeNotifier {
  ...
  /// `false` no workspace de sistema "FlightDeck" (terminal-only): o item
  ...
  /// O `FlightDeckPage` publica o estado atual. Callbacks são sempre atualizados;
  ...
  void setWorkspace({
    ...
    // FlightDeckPage clears this bridge from dispose(), which runs while Flutter
