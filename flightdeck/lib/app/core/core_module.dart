import 'package:flightdeck/app/core/data/automation/cli_automation_gateway.dart';
import 'package:flightdeck/app/core/data/lsp/lsp_client_impl.dart';
import 'package:flightdeck/app/core/data/lsp/lsp_server_pool.dart';
import 'package:flightdeck/app/core/data/relay/pairing_gateway_impl.dart';
import 'package:flightdeck/app/core/data/relay/revoke_gateway_impl.dart';
import 'package:flightdeck/app/core/data/setup/environment_probe_impl.dart';
import 'package:flightdeck/app/core/data/setup/system_permissions_impl.dart';
import 'package:flightdeck/app/core/domain/contracts/environment_probe.dart';
import 'package:flightdeck/app/core/domain/contracts/lsp_client.dart';
import 'package:flightdeck/app/core/domain/contracts/pairing_gateway.dart';
import 'package:flightdeck/app/core/domain/contracts/revoke_gateway.dart';
import 'package:flightdeck/app/core/domain/contracts/system_permissions.dart';
...
///
/// - [PiSpawnConfig]: o flightdeck injeta para spawnar `pi --mode rpc`; o settings,
...
///   por todos os workspaces. Root-owned aqui; o `FlightDeckViewModel` (page-scoped)
...
///   features — o flightdeck usa no checklist do agente (`SetupViewModel`) e o
...
///   Compartilhado — o flightdeck resolve o perfil ao abrir uma aba (o `+` e seu
