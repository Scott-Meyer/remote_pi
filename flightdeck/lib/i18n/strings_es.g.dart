...
class TranslationsEs extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _Translations$flightdeck$es flightdeck = _Translations$flightdeck$es._(_root);
...
// Path: flightdeck
class _Translations$flightdeck$es extends Translations$flightdeck$en {
	_Translations$flightdeck$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override late final _Translations$flightdeck$confirmDialog$es confirmDialog = _Translations$flightdeck$confirmDialog$es._(_root);
	@override late final _Translations$flightdeck$historyDialog$es historyDialog = _Translations$flightdeck$historyDialog$es._(_root);
	@override late final _Translations$flightdeck$worktreeCreateDialog$es worktreeCreateDialog = _Translations$flightdeck$worktreeCreateDialog$es._(_root);
	@override late final _Translations$flightdeck$subfolderDialog$es subfolderDialog = _Translations$flightdeck$subfolderDialog$es._(_root);
	@override late final _Translations$flightdeck$commitMessageDialog$es commitMessageDialog = _Translations$flightdeck$commitMessageDialog$es._(_root);
	@override late final _Translations$flightdeck$agentEditDialog$es agentEditDialog = _Translations$flightdeck$agentEditDialog$es._(_root);
	@override late final _Translations$flightdeck$agentSetupChecklist$es agentSetupChecklist = _Translations$flightdeck$agentSetupChecklist$es._(_root);
	@override late final _Translations$flightdeck$agentComposer$es agentComposer = _Translations$flightdeck$agentComposer$es._(_root);
	@override late final _Translations$flightdeck$tasksPanel$es tasksPanel = _Translations$flightdeck$tasksPanel$es._(_root);
	@override late final _Translations$flightdeck$flightdeckPage$es flightdeckPage = _Translations$flightdeck$flightdeckPage$es._(_root);
	@override late final _Translations$flightdeck$welcomeView$es welcomeView = _Translations$flightdeck$welcomeView$es._(_root);
	@override late final _Translations$flightdeck$modelPicker$es modelPicker = _Translations$flightdeck$modelPicker$es._(_root);
	@override late final _Translations$flightdeck$paneView$es paneView = _Translations$flightdeck$paneView$es._(_root);
	@override late final _Translations$flightdeck$fileTreePanel$es fileTreePanel = _Translations$flightdeck$fileTreePanel$es._(_root);
	@override late final _Translations$flightdeck$fileViewer$es fileViewer = _Translations$flightdeck$fileViewer$es._(_root);
	@override late final _Translations$flightdeck$workspaceSettingsDialog$es workspaceSettingsDialog = _Translations$flightdeck$workspaceSettingsDialog$es._(_root);
	@override late final _Translations$flightdeck$realmDialogs$es realmDialogs = _Translations$flightdeck$realmDialogs$es._(_root);
	@override late final _Translations$flightdeck$dbRedisTable$es dbRedisTable = _Translations$flightdeck$dbRedisTable$es._(_root);
	@override late final _Translations$flightdeck$dbQueryView$es dbQueryView = _Translations$flightdeck$dbQueryView$es._(_root);
	@override late final _Translations$flightdeck$httpView$es httpView = _Translations$flightdeck$httpView$es._(_root);
	@override late final _Translations$flightdeck$kanbanView$es kanbanView = _Translations$flightdeck$kanbanView$es._(_root);
	@override late final _Translations$flightdeck$dbPanel$es dbPanel = _Translations$flightdeck$dbPanel$es._(_root);
	@override late final _Translations$flightdeck$dbMongoView$es dbMongoView = _Translations$flightdeck$dbMongoView$es._(_root);
	@override late final _Translations$flightdeck$dbConnectionDialog$es dbConnectionDialog = _Translations$flightdeck$dbConnectionDialog$es._(_root);
	@override late final _Translations$flightdeck$sshPrompts$es sshPrompts = _Translations$flightdeck$sshPrompts$es._(_root);
	@override late final _Translations$flightdeck$projectsRail$es projectsRail = _Translations$flightdeck$projectsRail$es._(_root);
	@override late final _Translations$flightdeck$findBar$es findBar = _Translations$flightdeck$findBar$es._(_root);
	@override late final _Translations$flightdeck$contentSearch$es contentSearch = _Translations$flightdeck$contentSearch$es._(_root);
	@override late final _Translations$flightdeck$emptyPane$es emptyPane = _Translations$flightdeck$emptyPane$es._(_root);
	@override late final _Translations$flightdeck$topbar$es topbar = _Translations$flightdeck$topbar$es._(_root);
	@override late final _Translations$flightdeck$transcript$es transcript = _Translations$flightdeck$transcript$es._(_root);
	@override late final _Translations$flightdeck$tasks$es tasks = _Translations$flightdeck$tasks$es._(_root);
	@override late final _Translations$flightdeck$notifications$es notifications = _Translations$flightdeck$notifications$es._(_root);
	@override late final _Translations$flightdeck$terminal$es terminal = _Translations$flightdeck$terminal$es._(_root);
	@override late final _Translations$flightdeck$remoteHost$es remoteHost = _Translations$flightdeck$remoteHost$es._(_root);
	@override late final _Translations$flightdeck$browserPane$es browserPane = _Translations$flightdeck$browserPane$es._(_root);
	@override late final _Translations$flightdeck$gallery$es gallery = _Translations$flightdeck$gallery$es._(_root);
	@override late final _Translations$flightdeck$notebook$es notebook = _Translations$flightdeck$notebook$es._(_root);
}
...
class _Translations$core$bootstrapError$es extends Translations$core$bootstrapError$en {
	...
	// Translations
	@override String get title => 'No se pudo inicializar FlightDeck';
...
class _Translations$core$macosNotifications$es extends Translations$core$macosNotifications$en {
	...
	@override String get step3 => 'Busca y selecciona la aplicación FlightDeck en la lista.';
...
class _Translations$core$crash$es extends Translations$core$crash$en {
	...
	@override String get bannerTitle => 'FlightDeck se cerró inesperadamente';
	@override String get report => 'Reportar';
	@override String get dismiss => 'Descartar';
...
class _Translations$flightdeck$confirmDialog$es extends Translations$flightdeck$confirmDialog$en {
	_Translations$flightdeck$confirmDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$historyDialog$es extends Translations$flightdeck$historyDialog$en {
	_Translations$flightdeck$historyDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$worktreeCreateDialog$es extends Translations$flightdeck$worktreeCreateDialog$en {
	_Translations$flightdeck$worktreeCreateDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$subfolderDialog$es extends Translations$flightdeck$subfolderDialog$en {
	_Translations$flightdeck$subfolderDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$commitMessageDialog$es extends Translations$flightdeck$commitMessageDialog$en {
	_Translations$flightdeck$commitMessageDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$agentEditDialog$es extends Translations$flightdeck$agentEditDialog$en {
	_Translations$flightdeck$agentEditDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$agentSetupChecklist$es extends Translations$flightdeck$agentSetupChecklist$en {
	_Translations$flightdeck$agentSetupChecklist$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$agentComposer$es extends Translations$flightdeck$agentComposer$en {
	_Translations$flightdeck$agentComposer$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$tasksPanel$es extends Translations$flightdeck$tasksPanel$en {
	_Translations$flightdeck$tasksPanel$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$flightdeckPage$es extends Translations$flightdeck$flightdeckPage$en {
	_Translations$flightdeck$flightdeckPage$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$welcomeView$es extends Translations$flightdeck$welcomeView$en {
	_Translations$flightdeck$welcomeView$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Bienvenido a FlightDeck';
...
class _Translations$flightdeck$modelPicker$es extends Translations$flightdeck$modelPicker$en {
	_Translations$flightdeck$modelPicker$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$paneView$es extends Translations$flightdeck$paneView$en {
	_Translations$flightdeck$paneView$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$fileTreePanel$es extends Translations$flightdeck$fileTreePanel$en {
	_Translations$flightdeck$fileTreePanel$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$fileViewer$es extends Translations$flightdeck$fileViewer$en {
	_Translations$flightdeck$fileViewer$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$workspaceSettingsDialog$es extends Translations$flightdeck$workspaceSettingsDialog$en {
	_Translations$flightdeck$workspaceSettingsDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$realmDialogs$es extends Translations$flightdeck$realmDialogs$en {
	_Translations$flightdeck$realmDialogs$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$dbRedisTable$es extends Translations$flightdeck$dbRedisTable$en {
	_Translations$flightdeck$dbRedisTable$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$dbQueryView$es extends Translations$flightdeck$dbQueryView$en {
	_Translations$flightdeck$dbQueryView$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$httpView$es extends Translations$flightdeck$httpView$en {
	_Translations$flightdeck$httpView$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override late final _Translations$flightdeck$httpView$error$es error = _Translations$flightdeck$httpView$error$es._(_root);
}

// Path: flightdeck.kanbanView
class _Translations$flightdeck$kanbanView$es extends Translations$flightdeck$kanbanView$en {
	_Translations$flightdeck$kanbanView$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override late final _Translations$flightdeck$kanbanView$deleteColumnDialog$es deleteColumnDialog = _Translations$flightdeck$kanbanView$deleteColumnDialog$es._(_root);
}

// Path: flightdeck.dbPanel
class _Translations$flightdeck$dbPanel$es extends Translations$flightdeck$dbPanel$en {
	_Translations$flightdeck$dbPanel$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String footer({required Object n}) => '.flightdeck/databases.json · ${n} conexiones';
	@override String get footerOne => '.flightdeck/databases.json · 1 conexión';
...
class _Translations$flightdeck$dbMongoView$es extends Translations$flightdeck$dbMongoView$en {
	_Translations$flightdeck$dbMongoView$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$dbConnectionDialog$es extends Translations$flightdeck$dbConnectionDialog$en {
	_Translations$flightdeck$dbConnectionDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$sshPrompts$es extends Translations$flightdeck$sshPrompts$en {
	_Translations$flightdeck$sshPrompts$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get unknownSshHostTitle => 'Host SSH desconocido';
	@override String neverConnected({required Object endpoint}) => 'FlightDeck nunca se ha conectado a ${endpoint} antes.';
	...
	@override String get keptInMemoryHint => 'Se mantiene en memoria hasta que FlightDeck se cierre. Para que los agentes usen esta conexión, activa "Guardar frase de contraseña" en la conexión.';
	@override String get unlock => 'Desbloquear';
}

// Path: flightdeck.projectsRail
class _Translations$flightdeck$projectsRail$es extends Translations$flightdeck$projectsRail$en {
	_Translations$flightdeck$projectsRail$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$findBar$es extends Translations$flightdeck$findBar$en {
	_Translations$flightdeck$findBar$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$contentSearch$es extends Translations$flightdeck$contentSearch$en {
	_Translations$flightdeck$contentSearch$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$emptyPane$es extends Translations$flightdeck$emptyPane$en {
	_Translations$flightdeck$emptyPane$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$topbar$es extends Translations$flightdeck$topbar$en {
	_Translations$flightdeck$topbar$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String get filesUnavailable => 'Archivos no disponibles en FlightDeck';
	@override String get hideKeyboard => 'Ocultar teclado';
}

// Path: flightdeck.transcript
class _Translations$flightdeck$transcript$es extends Translations$flightdeck$transcript$en {
	_Translations$flightdeck$transcript$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$tasks$es extends Translations$flightdeck$tasks$en {
	_Translations$flightdeck$tasks$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$notifications$es extends Translations$flightdeck$notifications$en {
	_Translations$flightdeck$notifications$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$terminal$es extends Translations$flightdeck$terminal$en {
	_Translations$flightdeck$terminal$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$remoteHost$es extends Translations$flightdeck$remoteHost$en {
	_Translations$flightdeck$remoteHost$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override String errHostKeyUnknown({required Object host}) => 'FlightDeck todavía no confía en ${host}. Conecta de nuevo y confirma la huella.';
	...
	@override String errHostBundleMissing({required Object host}) => '${host} es Windows pero no tiene FlightDeck instalado. El servidor remoto se instala desde el bundle de FlightDeck que ya está en esa máquina — instálalo allí e inténtalo de nuevo.';
...
class _Translations$flightdeck$browserPane$es extends Translations$flightdeck$browserPane$en {
	_Translations$flightdeck$browserPane$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$es extends Translations$flightdeck$gallery$en {
	_Translations$flightdeck$gallery$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get intro => 'Documentos especiales de FlightDeck para que veas lo que el agente de IA está haciendo.';
	@override String get createErrorTitle => 'No se pudo crear el archivo';
	@override late final _Translations$flightdeck$gallery$dbQuery$es dbQuery = _Translations$flightdeck$gallery$dbQuery$es._(_root);
	@override late final _Translations$flightdeck$gallery$kanban$es kanban = _Translations$flightdeck$gallery$kanban$es._(_root);
	@override late final _Translations$flightdeck$gallery$layout$es layout = _Translations$flightdeck$gallery$layout$es._(_root);
	@override late final _Translations$flightdeck$gallery$httpRequest$es httpRequest = _Translations$flightdeck$gallery$httpRequest$es._(_root);
	@override late final _Translations$flightdeck$gallery$html$es html = _Translations$flightdeck$gallery$html$es._(_root);
	@override late final _Translations$flightdeck$gallery$tasks$es tasks = _Translations$flightdeck$gallery$tasks$es._(_root);
	@override late final _Translations$flightdeck$gallery$notebook$es notebook = _Translations$flightdeck$gallery$notebook$es._(_root);
}

// Path: flightdeck.notebook
class _Translations$flightdeck$notebook$es extends Translations$flightdeck$notebook$en {
	_Translations$flightdeck$notebook$es._(TranslationsEs root) : this._root = root, super.internal(root);
	...
	@override late final _Translations$flightdeck$notebook$format$es format = _Translations$flightdeck$notebook$format$es._(_root);
...
class _Translations$settings$remoteHosts$es extends Translations$settings$remoteHosts$en {
	...
	@override String get helpBody => 'FlightDeck se conecta a tu máquina por SSH y habla con un pequeño servidor que ejecuta las terminales, archivos y git allí. El host debe tener FlightDeck (escritorio) o el flightdeck-server instalado y en ejecución, y la clave pública de este dispositivo añadida en su ~/.ssh/authorized_keys.';
}
...
class _Translations$flightdeck$httpView$error$es extends Translations$flightdeck$httpView$error$en {
	_Translations$flightdeck$httpView$error$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$kanbanView$deleteColumnDialog$es extends Translations$flightdeck$kanbanView$deleteColumnDialog$en {
	_Translations$flightdeck$kanbanView$deleteColumnDialog$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$dbQuery$es extends Translations$flightdeck$gallery$dbQuery$en {
	_Translations$flightdeck$gallery$dbQuery$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$kanban$es extends Translations$flightdeck$gallery$kanban$en {
	_Translations$flightdeck$gallery$kanban$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$layout$es extends Translations$flightdeck$gallery$layout$en {
	_Translations$flightdeck$gallery$layout$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$httpRequest$es extends Translations$flightdeck$gallery$httpRequest$en {
	_Translations$flightdeck$gallery$httpRequest$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$gallery$html$es extends Translations$flightdeck$gallery$html$en {
	_Translations$flightdeck$gallery$html$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Vista HTML';
	@override String get description => 'Una página que el agente escribe y FlightDeck renderiza directo: mapa mental, diagrama, gráfico, lo que necesites.';
}

// Path: flightdeck.gallery.tasks
class _Translations$flightdeck$gallery$tasks$es extends Translations$flightdeck$gallery$tasks$en {
	_Translations$flightdeck$gallery$tasks$es._(TranslationsEs root) : this._root = root, super.internal(root);

	final TranslationsEs _root; // ignore: unused_field

	// Translations
	@override String get title => 'Tareas';
	@override String get description => 'Comandos para ejecutar desde el panel de Tasks, como dev server, tests y build. Vive en .flightdeck/tasks.json.';
}

// Path: flightdeck.gallery.notebook
class _Translations$flightdeck$gallery$notebook$es extends Translations$flightdeck$gallery$notebook$en {
	_Translations$flightdeck$gallery$notebook$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$flightdeck$notebook$format$es extends Translations$flightdeck$notebook$format$en {
	_Translations$flightdeck$notebook$format$es._(TranslationsEs root) : this._root = root, super.internal(root);
...
class _Translations$settings$page$general$es extends Translations$settings$page$general$en {
	...
	@override String get enableAgentsDesc => 'Muestra la opción de abrir pestañas de agente (pi). Cuando está desactivado, FlightDeck funciona solo como workspace de terminal.';
	@override String get showFlightDeckTitle => 'Mostrar terminal de FlightDeck';
	@override String get showFlightDeckDesc => 'Mantiene un workspace sin carpeta, solo de terminal, fijado en la parte superior de la barra lateral. Desactivarlo cierra sus terminales.';
	@override String get launchAtStartupTitle => 'Iniciar al arrancar';
	@override String get launchAtStartupDesc => 'Inicia FlightDeck automáticamente cuando inicias sesión en tu computadora.';
	@override String get sectionUpdates => 'Actualizaciones';
	@override String get checkUpdatesTitle => 'Buscar actualizaciones';
	@override String get checkUpdatesDesc => 'Con qué frecuencia FlightDeck debe buscar nuevas versiones.';
...
class _Translations$settings$page$storage$es extends Translations$settings$page$storage$en {
	...
	@override String locationDesc({required Object root}) => 'FlightDeck guarda aquí sus proyectos, diseños y configuración. Apúntalo a una carpeta sincronizada para respaldarlo.\n${root}';
	...
	@override String get resetTitle => 'Restablecer FlightDeck';
	...
	@override String get resetDialogTitle => '¿Restablecer FlightDeck?';
	@override String get resetDialogContent => 'Esto elimina permanentemente todos los datos locales de FlightDeck — proyectos, diseños, configuración e historial de terminal. Esto no se puede deshacer. FlightDeck se cerrará para que puedas empezar de nuevo.';
	@override String get restartRequiredTitle => 'Reinicio necesario';
	@override String restartChangeFolderMessage({required Object path}) => 'FlightDeck usará esta carpeta a partir del próximo inicio:\n${path}';
	@override String get restartUseDefaultMessage => 'FlightDeck usará la ubicación predeterminada del sistema a partir del próximo inicio. Tus datos en la carpeta personalizada permanecen intactos.';
	@override String get restartResetMessage => 'Se borraron todos los datos de FlightDeck. Reinicia para empezar de nuevo.';
	@override String get later => 'Más tarde';
	@override String get quitFlightDeck => 'Salir de FlightDeck';
	@override String get chooseFolderDialogTitle => 'Elige una carpeta para los datos de FlightDeck';
}
...
class _Translations$settings$page$terminal$es extends Translations$settings$page$terminal$en {
	...
	@override String get noWslMessage => 'No se encontraron distros de WSL. Instala una (wsl.exe --install) y reinicia FlightDeck para verla listada aquí.';
}
...
class _Translations$settings$page$notifications$es extends Translations$settings$page$notifications$en {
	...
	@override String get grantedDesc => 'FlightDeck tiene permiso para enviar notificaciones.';
...
class _Translations$settings$page$languages$es extends Translations$settings$page$languages$en {
	...
	@override String get footerNote => 'Los errores y el formato usan el language server de cada lenguaje. FlightDeck no instala servidores — usa lo que ya está en tu máquina. ● responde · ○ no encontrado o comando inválido (instala el servidor o ajusta el comando).';
...
class _Translations$settings$page$automations$es extends Translations$settings$page$automations$en {
	...
	@override String get generateFromSourceControlDescription => 'FlightDeck envía solo el diff seleccionado y los asuntos de los commits recientes. Los patrones habituales de credenciales y los archivos sensibles se redactan antes de ejecutar el harness.';
...
extension on TranslationsEs {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			'core.bootstrapError.title' => 'No se pudo inicializar FlightDeck',
			...
			'core.macosNotifications.step3' => 'Busca y selecciona la aplicación FlightDeck en la lista.',
			...
			'core.crash.bannerTitle' => 'FlightDeck se cerró inesperadamente',
			...
			'flightdeck.confirmDialog.unsavedChangesTitle' => 'Cambios sin guardar',
			'flightdeck.confirmDialog.unsavedChangesMessage' => ({required Object fileName}) => '“${fileName}” tiene cambios sin guardar. ¿Guardarlos antes de cerrar?',
			'flightdeck.confirmDialog.dontSave' => 'No guardar',
			'flightdeck.confirmDialog.saveAndClose' => 'Guardar y cerrar',
			'flightdeck.historyDialog.title' => 'Historial de sesiones',
			'flightdeck.historyDialog.subtitle' => 'Abrir una reemplaza la transcripción actual de este agente',
			'flightdeck.historyDialog.empty' => 'No hay sesiones guardadas en esta carpeta.',
			'flightdeck.historyDialog.untitledSession' => 'Sesión sin título',
			'flightdeck.historyDialog.justNow' => 'ahora',
			'flightdeck.historyDialog.minutesAgo' => ({required Object n}) => 'hace ${n} min',
			'flightdeck.historyDialog.hoursAgo' => ({required Object n}) => 'hace ${n} h',
			'flightdeck.historyDialog.daysAgo' => ({required Object n}) => 'hace ${n} d',
			'flightdeck.worktreeCreateDialog.forkTitle' => 'Fork del worktree',
			'flightdeck.worktreeCreateDialog.createTitle' => 'Crear worktree',
			'flightdeck.worktreeCreateDialog.forkSubtitle' => ({required Object root}) => 'Nueva worktree ramificada desde ${root}.',
			'flightdeck.worktreeCreateDialog.createSubtitle' => ({required Object root}) => 'Nueva feature en ${root} — nueva branch desde el HEAD actual.',
			'flightdeck.worktreeCreateDialog.namePlaceholder' => 'feat/mi-feature',
			'flightdeck.worktreeCreateDialog.errorWhitespace' => 'Sin espacios en el nombre.',
			'flightdeck.worktreeCreateDialog.errorInvalidChar' => 'Carácter inválido para un nombre de branch.',
			'flightdeck.worktreeCreateDialog.errorInvalidSequence' => 'Secuencia inválida (ej.: "..", "//", empezar/terminar con "/").',
			'flightdeck.worktreeCreateDialog.errorReserved' => 'Posición reservada (no empieces con "-"/"." ni termines con ".lock").',
			'flightdeck.worktreeCreateDialog.errorDuplicateBranch' => 'Ya existe una branch con ese nombre.',
			'flightdeck.worktreeCreateDialog.errorDuplicateWorktree' => 'Ya existe un worktree con ese nombre.',
			'flightdeck.worktreeCreateDialog.errorBranchHierarchyConflict' => ({required Object target, required Object existing}) => 'No se puede crear la branch \'${target}\' porque entra en conflicto con la branch \'${existing}\' ya existente.',
			'flightdeck.worktreeCreateDialog.errorBranchHierarchicalConflictGeneral' => 'Ya existe una branch con una jerarquía conflictiva.',
			'flightdeck.worktreeCreateDialog.fork' => 'Fork',
			'flightdeck.worktreeCreateDialog.postCheckoutHint' => 'Este repositorio tiene un hook post-checkout.',
			'flightdeck.worktreeCreateDialog.running' => 'Ejecutando…',
			'flightdeck.worktreeCreateDialog.advancedSettings' => 'Configuración Avanzada',
			'flightdeck.worktreeCreateDialog.copyIgnored' => 'Copiar archivos ignorados (.gitignore)',
			'flightdeck.worktreeCreateDialog.copyIgnoredDesc' => 'Copia los archivos ignorados por .gitignore (ej. .env, claves locales) al nuevo worktree.',
			'flightdeck.worktreeCreateDialog.copyUntracked' => 'Copiar archivos no rastreados',
			'flightdeck.worktreeCreateDialog.copyUntrackedDesc' => 'Copia los archivos nuevos o modificados que aún no se han agregado al stage.',
			'flightdeck.worktreeCreateDialog.baseBranch' => 'Branch base',
			'flightdeck.worktreeCreateDialog.baseBranchDesc' => 'La branch desde la cual se creará el nuevo worktree y branch.',
			'flightdeck.worktreeCreateDialog.fetchRemote' => 'Sincronizar branch remota (fetch)',
			'flightdeck.worktreeCreateDialog.fetchRemoteDesc' => 'Ejecuta git fetch para garantizar que la branch base esté confirmada antes de crear el worktree.',
			'flightdeck.worktreeCreateDialog.searchBranch' => 'Buscar branch...',
			'flightdeck.worktreeCreateDialog.back' => 'Atrás',
			'flightdeck.subfolderDialog.title' => '¿Dónde trabajar?',
			'flightdeck.subfolderDialog.empty' => 'No hay subcarpetas aquí.',
			'flightdeck.subfolderDialog.useRoot' => ({required Object project}) => 'Usar la raíz de ${project}',
			'flightdeck.subfolderDialog.usePath' => ({required Object project, required Object rel}) => 'Usar ${project}/${rel}',
			'flightdeck.subfolderDialog.useThisFolder' => 'Usar esta carpeta',
			'flightdeck.commitMessageDialog.commitTitle' => 'Commit',
			'flightdeck.commitMessageDialog.stageAndCommitTitle' => 'Stage y Commit',
			'flightdeck.commitMessageDialog.scopeNote' => ({required Object fileName}) => 'Commit solo de "${fileName}".',
			'flightdeck.commitMessageDialog.placeholder' => 'fix: resumen breve del cambio',
			'flightdeck.commitMessageDialog.errorEmptySubject' => 'La primera línea (asunto) no puede estar vacía.',
			'flightdeck.commitMessageDialog.errorTooShort' => ({required Object min}) => 'Asunto demasiado corto (mín. ${min} caracteres).',
			'flightdeck.commitMessageDialog.errorTooLong' => ({required Object max}) => 'Asunto demasiado largo (máx. ${max} caracteres).',
			'flightdeck.commitMessageDialog.errorTrailingPeriod' => 'El asunto no debe terminar con un punto.',
			'flightdeck.commitMessageDialog.errorControlChars' => 'El asunto contiene caracteres de control.',
			'flightdeck.commitMessageDialog.errorBlankSecondLine' => 'Deja la segunda línea en blanco (separador entre asunto y cuerpo de git).',
			'flightdeck.commitMessageDialog.generate' => 'Generar mensaje de commit',
			'flightdeck.commitMessageDialog.generateWith' => ({required Object harness}) => 'Generar con ${harness}',
			'flightdeck.commitMessageDialog.generating' => 'Generando…',
			'flightdeck.commitMessageDialog.cancelGeneration' => 'Cancelar generación',
			'flightdeck.agentEditDialog.title' => 'Editar agente',
			'flightdeck.agentEditDialog.agentName' => 'Nombre del agente',
			'flightdeck.agentEditDialog.relaySection' => 'Relay (remote-pi)',
			'flightdeck.agentEditDialog.autoConnect' => 'Conectar automáticamente al iniciar',
			'flightdeck.agentEditDialog.informationSection' => 'Información',
			'flightdeck.agentEditDialog.folder' => 'Carpeta',
			...
			'flightdeck.agentEditDialog.statusEmpty' => 'vacío',
			'flightdeck.agentEditDialog.statusStarting' => 'iniciando',
			'flightdeck.agentEditDialog.statusReady' => 'listo',
			'flightdeck.agentEditDialog.statusStreaming' => 'transmitiendo',
			'flightdeck.agentEditDialog.statusEnded' => 'finalizado',
			'flightdeck.agentSetupChecklist.title' => 'Configurar el entorno del agente',
			'flightdeck.agentSetupChecklist.intro' => 'Ejecutar un agente requiere tener Pi instalado. Completa los pasos siguientes — las terminales y los archivos funcionan sin nada de esto.',
			'flightdeck.agentSetupChecklist.step1Title' => 'Pi Code instalado',
			'flightdeck.agentSetupChecklist.step1Description' => 'El binario `pi` debe estar accesible.',
			'flightdeck.agentSetupChecklist.step2Title' => 'Extensión remote-pi en Pi',
			'flightdeck.agentSetupChecklist.step2Description' => 'Registrada en ~/.pi/agent/settings.json.',
			'flightdeck.agentSetupChecklist.step3Title' => 'Supervisor instalado',
			'flightdeck.agentSetupChecklist.step3Description' => 'Servicio pi-supervisord (remote-pi install).',
			'flightdeck.agentSetupChecklist.install' => 'Instalar',
			'flightdeck.agentSetupChecklist.installExtensionTitle' => 'Instalar extensión remote-pi',
			'flightdeck.agentSetupChecklist.installSupervisorTitle' => 'Instalar supervisor',
			'flightdeck.agentSetupChecklist.createAgent' => 'Crear agente',
			'flightdeck.agentSetupChecklist.back' => 'Atrás',
			'flightdeck.agentSetupChecklist.checkAgain' => 'Comprobar de nuevo',
			'flightdeck.agentSetupChecklist.notRequired' => 'No obligatorio en esta configuración',
			'flightdeck.agentSetupChecklist.installing' => 'Instalando…',
			'flightdeck.agentSetupChecklist.installedSuccessfully' => 'Instalado correctamente.',
			'flightdeck.agentComposer.cmdNewDescription' => 'Nueva sesión — borra la conversación',
			'flightdeck.agentComposer.cmdCompactDescription' => 'Compacta el contexto del agente',
			'flightdeck.agentComposer.attachFile' => 'Adjuntar archivo',
			'flightdeck.agentComposer.maxImages' => ({required Object max}) => 'Máximo de ${max} imágenes.',
			'flightdeck.agentComposer.placeholder' => 'Mensaje para el agente, usa @files o /commands',
			'flightdeck.agentComposer.stop' => 'Detener',
			'flightdeck.agentComposer.send' => 'Enviar',
			'flightdeck.agentComposer.relayOnline' => 'Relay en línea',
			'flightdeck.agentComposer.relayReconnecting' => 'Relay reconectando...',
			'flightdeck.agentComposer.relayOffline' => 'Relay sin conexión',
			'flightdeck.agentComposer.contextTooltip' => ({required Object pct}) => 'Contexto: ${pct}% de la ventana',
			'flightdeck.agentComposer.visionWarning' => 'El modelo actual no puede ver imágenes — cambia a uno con soporte de visión.',
			'flightdeck.agentComposer.modelFallback' => 'modelo',
			'flightdeck.tasksPanel.reloadTasksTooltip' => 'Recargar tasks',
			'flightdeck.tasksPanel.restartTooltip' => 'Reiniciar',
			'flightdeck.tasksPanel.stopTooltip' => 'Detener',
			'flightdeck.tasksPanel.runTooltip' => 'Ejecutar',
			'flightdeck.tasksPanel.sendsKeyTooltip' => ({required Object label, required Object key}) => '${label} (envía \'${key}\')',
			'flightdeck.tasksPanel.startingTooltip' => 'Iniciando…',
			'flightdeck.tasksPanel.stoppingTooltip' => 'Deteniendo…',
			'flightdeck.tasksPanel.switchProfileTooltip' => 'Cambiar perfil',
			'flightdeck.tasksPanel.moreKeysTooltip' => 'Más teclas',
			'flightdeck.tasksPanel.sectionTasks' => 'TAREAS',
			'flightdeck.tasksPanel.noTasks' => 'No se detectaron tareas en este proyecto.',
			'flightdeck.tasksPanel.createTasksJson' => 'Crear tasks.json',
			'flightdeck.flightdeckPage.chooseProjectFolderDialogTitle' => 'Elige la carpeta del proyecto',
			'flightdeck.flightdeckPage.chooseWorkspaceFolderDialogTitle' => 'Elige la carpeta del workspace',
			'flightdeck.flightdeckPage.workspaceRenamedTitle' => 'Workspace renombrado',
			'flightdeck.flightdeckPage.workspaceRenamedMessage' => ({required Object name}) => 'El nuevo nombre "${name}" solo se enviará a los agentes tras reiniciar el workspace o la aplicación.',
			...
			'flightdeck.flightdeckPage.updateFromParentTitle' => ({required Object name}) => 'Actualizar desde el Padre — ${name}',
			'flightdeck.flightdeckPage.mergeToParentTitle' => ({required Object name}) => 'Merge al Padre — ${name}',
			'flightdeck.flightdeckPage.worktreeMergedAndRemoved' => 'Worktree fusionado y eliminado.',
			'flightdeck.flightdeckPage.nothingWasChanged' => 'No se realizaron cambios.',
			'flightdeck.flightdeckPage.newRealmTitle' => 'Nuevo realm',
			'flightdeck.flightdeckPage.closeWorkspaceTitle' => 'Cerrar workspace',
			'flightdeck.flightdeckPage.closeWorkspaceMessage' => ({required Object name}) => '¿Cerrar "${name}"? Los agentes de este workspace se cerrarán. La carpeta en el disco se conserva.',
			'flightdeck.flightdeckPage.closeAction' => 'Cerrar',
			'flightdeck.flightdeckPage.removeWorktreeTitle' => 'Quitar worktree',
			'flightdeck.flightdeckPage.removeWorktreeMessage' => ({required Object name, required Object warn}) => '¿Quitar "${name}"? La carpeta del worktree y la branch se eliminarán y los agentes de este fork se cerrarán.${warn}',
			'flightdeck.flightdeckPage.removeWorktreeWarning' => ({required Object name}) => '\n\nAdvertencia: la branch "${name}" aún no se ha fusionado — eliminarla (git branch -D) descarta el trabajo no fusionado.',
			'flightdeck.flightdeckPage.failedToRemoveWorktreeTitle' => 'No se pudo quitar el worktree',
			'flightdeck.flightdeckPage.openLayoutTitle' => 'Abrir layout',
			'flightdeck.flightdeckPage.restartServerTooltip' => 'Reiniciar servidor',
			'flightdeck.flightdeckPage.noLspAvailable' => 'Ningún LSP disponible',
			'flightdeck.flightdeckPage.lspRunning' => 'en ejecución',
			'flightdeck.flightdeckPage.lspStopped' => 'detenido',
			'flightdeck.welcomeView.title' => 'Bienvenido a FlightDeck',
			'flightdeck.welcomeView.subtitle' => 'Abre una carpeta o conéctate a un host remoto para empezar.',
			'flightdeck.welcomeView.createWorkspace' => 'Crear workspace',
			'flightdeck.welcomeView.openLocalFolder' => 'Abrir carpeta local',
			'flightdeck.welcomeView.connectHost' => 'Conectar a un host',
			'flightdeck.welcomeView.configureHost' => 'Configurar host',
			'flightdeck.welcomeView.addWorkspace' => 'Añadir workspace',
			'flightdeck.modelPicker.search' => ({required Object count}) => 'Buscar modelo (${count})',
			'flightdeck.paneView.closePaneTitle' => '¿Cerrar panel?',
			'flightdeck.paneView.closePaneMessage' => ({required Object count}) => 'Esto cierra todas las ${count} pestaña(s) de este panel y finaliza los agentes/terminales en él.',
			'flightdeck.paneView.close' => 'Cerrar',
			'flightdeck.paneView.allTabs' => 'Todas las pestañas',
			'flightdeck.paneView.pinTab' => 'Fijar pestaña',
			'flightdeck.paneView.rename' => 'Renombrar',
			'flightdeck.paneView.openAsMarkdown' => 'Abrir como markdown',
			'flightdeck.paneView.openAsBoard' => 'Abrir como tablero',
			'flightdeck.paneView.resetTitle' => 'Restablecer título',
			'flightdeck.paneView.copyId' => 'Copiar Id',
			'flightdeck.paneView.autoRelay' => 'Auto-relay',
			'flightdeck.paneView.history' => 'Historial',
			'flightdeck.paneView.newTab' => 'Nueva pestaña',
			'flightdeck.paneView.newTerminal' => 'Nueva terminal…',
			'flightdeck.paneView.splitRight' => 'Dividir a la derecha',
			'flightdeck.paneView.splitDown' => 'Dividir abajo',
			'flightdeck.paneView.closePane' => 'Cerrar panel',
			'flightdeck.paneView.dropHereToMove' => 'Suelta aquí para mover la pestaña',
			'flightdeck.paneView.dockAsTab' => 'Acoplar como pestaña',
			...
			'flightdeck.fileTreePanel.stageAndCommit' => 'Stage y Commit',
			'flightdeck.fileTreePanel.unstage' => 'Quitar del stage',
			'flightdeck.fileTreePanel.stageChanges' => 'Poner en stage',
			'flightdeck.fileTreePanel.discardChanges' => 'Descartar cambios',
			'flightdeck.fileTreePanel.enterCommitMessage' => 'Escribe un mensaje de commit.',
			'flightdeck.fileTreePanel.commitUnavailable' => 'Commit no disponible para este workspace.',
			'flightdeck.fileTreePanel.gitErrorTitle' => 'Error de Git',
			'flightdeck.fileTreePanel.deleteNewFileTitle' => '¿Eliminar archivo nuevo?',
			'flightdeck.fileTreePanel.discardChangesTitle' => '¿Descartar cambios?',
			'flightdeck.fileTreePanel.deleteNewFileMessage' => ({required Object name}) => '"${name}" es un archivo nuevo y no se puede restaurar. ¿Eliminarlo?',
			'flightdeck.fileTreePanel.discardOneMessage' => ({required Object name}) => '¿Descartar todos los cambios en "${name}"? Los archivos eliminados se restaurarán.',
			'flightdeck.fileTreePanel.discard' => 'Descartar',
			'flightdeck.fileTreePanel.deleteAllNewFilesTitle' => '¿Eliminar todos los archivos nuevos?',
			'flightdeck.fileTreePanel.allNewFilesMessage' => ({required Object count}) => 'Los ${count} archivos son nuevos y se eliminarán. Esto no se puede deshacer.',
			'flightdeck.fileTreePanel.discardTrackedMessage' => ({required Object count, required Object extra}) => '¿Descartar cambios en ${count} archivo(s) rastreado(s)?${extra}',
			'flightdeck.fileTreePanel.discardTrackedExtra' => ({required Object count}) => ' Se mantendrán ${count} archivo(s) nuevo(s).',
			'flightdeck.fileTreePanel.deleteAll' => 'Eliminar todo',
			'flightdeck.fileTreePanel.deleteQuestionTitle' => '¿Eliminar?',
			'flightdeck.fileTreePanel.moveToTrash' => ({required Object name}) => '¿Mover “${name}” a la Papelera?',
			'flightdeck.fileTreePanel.permanentlyDelete' => ({required Object name}) => '¿Eliminar “${name}” de forma permanente? Esto no se puede deshacer.',
			'flightdeck.fileTreePanel.couldNotDeleteTitle' => 'No se pudo eliminar',
			'flightdeck.fileTreePanel.moveQuestionTitle' => '¿Mover?',
			'flightdeck.fileTreePanel.moveMessage' => ({required Object name, required Object dest}) => '¿Mover “${name}” a “${dest}”?',
			'flightdeck.fileTreePanel.moveAction' => 'Mover',
			'flightdeck.fileTreePanel.couldNotMoveTitle' => 'No se pudo mover',
			'flightdeck.fileTreePanel.couldNotPasteTitle' => 'No se pudo pegar',
			'flightdeck.fileTreePanel.filesTooltip' => 'Archivos',
			'flightdeck.fileTreePanel.searchTooltip' => 'Buscar',
			'flightdeck.fileTreePanel.sourceControlTooltip' => 'Control de versiones',
			'flightdeck.fileTreePanel.databaseTooltip' => 'Base de datos',
			'flightdeck.fileTreePanel.sectionFiles' => 'ARCHIVOS',
			'flightdeck.fileTreePanel.newFile' => 'Nuevo archivo',
			'flightdeck.fileTreePanel.newFolder' => 'Nueva carpeta',
			'flightdeck.fileTreePanel.refreshTooltip' => 'Actualizar',
			'flightdeck.fileTreePanel.collapseAll' => 'Contraer todas las carpetas',
			'flightdeck.fileTreePanel.sectionSourceControl' => 'CONTROL DE VERSIONES',
			'flightdeck.fileTreePanel.viewAsList' => 'Ver como lista',
			'flightdeck.fileTreePanel.viewAsTree' => 'Ver como árbol',
			'flightdeck.fileTreePanel.noFolderMessage' => 'Ninguna carpeta — abre un workspace.',
			'flightdeck.fileTreePanel.amend' => 'Amend',
			'flightdeck.fileTreePanel.commitMessagePlaceholder' => 'Mensaje del commit',
			'flightdeck.fileTreePanel.amendCommit' => 'Amend del commit',
			'flightdeck.fileTreePanel.lastCommit' => 'último commit',
			'flightdeck.fileTreePanel.openInFinder' => 'Abrir en Finder',
			'flightdeck.fileTreePanel.openInExplorer' => 'Abrir en el Explorador',
			'flightdeck.fileTreePanel.openInFileManager' => 'Abrir en el gestor de archivos',
			'flightdeck.fileTreePanel.open' => 'Abrir',
			'flightdeck.fileTreePanel.openWith' => 'Abrir con',
			'flightdeck.fileTreePanel.openLayout' => 'Abrir layout',
			'flightdeck.fileTreePanel.openAsMarkdown' => 'Abrir como markdown',
			'flightdeck.fileTreePanel.showGitDiff' => 'Mostrar diff de git',
			'flightdeck.fileTreePanel.createAgent' => 'Crear agente',
			'flightdeck.fileTreePanel.createTerminal' => 'Crear terminal',
			'flightdeck.fileTreePanel.rename' => 'Renombrar',
			'flightdeck.fileTreePanel.copy' => 'Copiar',
			'flightdeck.fileTreePanel.cut' => 'Cortar',
			'flightdeck.fileTreePanel.paste' => 'Pegar',
			'flightdeck.fileTreePanel.copyRelativePath' => 'Copiar ruta relativa',
			'flightdeck.fileTreePanel.copyAbsolutePath' => 'Copiar ruta absoluta',
			'flightdeck.fileTreePanel.renameFailed' => 'No se pudo renombrar.',
			'flightdeck.fileTreePanel.noChanges' => 'Sin cambios.',
			'flightdeck.fileTreePanel.stagedChangesHeader' => ({required Object count}) => 'CAMBIOS EN STAGE (${count})',
			'flightdeck.fileTreePanel.changesHeader' => ({required Object count}) => 'CAMBIOS (${count})',
			'flightdeck.fileTreePanel.discardAllChanges' => 'Descartar todos los cambios',
			'flightdeck.fileTreePanel.unstageAllChanges' => 'Quitar todo del stage',
			'flightdeck.fileTreePanel.stageAllChanges' => 'Poner todo en stage',
			'flightdeck.fileTreePanel.discardFolderChanges' => 'Descartar cambios de la carpeta',
			'flightdeck.fileTreePanel.unstageFolderChanges' => 'Quitar carpeta del stage',
			'flightdeck.fileTreePanel.stageFolderChanges' => 'Poner carpeta en stage',
			'flightdeck.fileTreePanel.generateCommitMessage' => 'Generar mensaje de commit',
			'flightdeck.fileTreePanel.generateWith' => ({required Object harness}) => 'Generar con ${harness}',
			'flightdeck.fileTreePanel.generateUnavailableWhileAmending' => 'No disponible mientras se enmienda un commit',
			'flightdeck.fileTreePanel.cancelGeneration' => 'Cancelar generación',
			'flightdeck.fileTreePanel.changes' => 'Cambios',
			'flightdeck.fileTreePanel.history' => 'Historial',
			'flightdeck.fileTreePanel.historyRepository' => 'Repositorio',
			'flightdeck.fileTreePanel.historyNoRepository' => 'No hay ningun repositorio Git disponible.',
			'flightdeck.fileTreePanel.historyEmpty' => 'No se encontraron commits.',
			'flightdeck.fileTreePanel.historyLoadFailed' => 'No se pudo cargar el historial de Git.',
			'flightdeck.fileTreePanel.historyUntitledCommit' => 'Commit sin titulo',
			'flightdeck.fileTreePanel.historyNow' => 'ahora',
			'flightdeck.fileTreePanel.historyMinutesAgo' => ({required Object count}) => 'hace ${count} min',
			'flightdeck.fileTreePanel.historyHoursAgo' => ({required Object count}) => 'hace ${count} h',
			'flightdeck.fileTreePanel.historyYesterday' => 'ayer',
			'flightdeck.fileTreePanel.historyDayAgo' => 'hace 1 dia',
			'flightdeck.fileTreePanel.historyDaysAgo' => ({required Object count}) => 'hace ${count} dias',
			'flightdeck.fileTreePanel.historyFiles' => 'Archivos modificados',
			'flightdeck.fileTreePanel.historyFilesEmpty' => 'No hay archivos modificados.',
			'flightdeck.fileTreePanel.historyFilesLoadFailed' => 'No se pudieron cargar los archivos modificados.',
			'flightdeck.fileTreePanel.diffEmptyTree' => 'Arbol vacio',
			...
			'flightdeck.fileTreePanel.diffWorkingTree' => 'Directorio de trabajo',
			'flightdeck.fileTreePanel.diffBinaryFile' => 'Archivo binario - sin diff de texto.',
			'flightdeck.fileTreePanel.diffNoChanges' => 'Sin cambios.',
			'flightdeck.fileTreePanel.diffError' => ({required Object detail}) => 'No se pudo leer el diff: ${detail}',
			'flightdeck.fileTreePanel.galleryTooltip' => 'Galería',
			'flightdeck.fileTreePanel.sectionGallery' => 'GALERÍA',
			'flightdeck.fileViewer.cantOpen' => 'No se puede abrir este archivo.',
			'flightdeck.fileViewer.couldNotLoadImage' => 'No se pudo cargar la imagen.',
			'flightdeck.fileViewer.preview' => 'Vista previa',
			'flightdeck.fileViewer.source' => 'Código fuente',
			'flightdeck.workspaceSettingsDialog.choosePhotoTitle' => 'Elegir foto del workspace',
			'flightdeck.workspaceSettingsDialog.title' => 'Configuración del workspace',
			'flightdeck.workspaceSettingsDialog.namePlaceholder' => 'Nombre del workspace',
			'flightdeck.workspaceSettingsDialog.addPhoto' => 'Añadir foto',
			'flightdeck.workspaceSettingsDialog.changePhoto' => 'Cambiar foto',
			'flightdeck.workspaceSettingsDialog.remove' => 'Quitar',
			'flightdeck.workspaceSettingsDialog.color' => 'Color',
			'flightdeck.workspaceSettingsDialog.host' => 'Host',
			'flightdeck.workspaceSettingsDialog.folder' => 'Carpeta',
			'flightdeck.realmDialogs.namePlaceholder' => 'Nombre del realm',
			'flightdeck.realmDialogs.duplicateName' => 'Ya existe un realm con ese nombre.',
			'flightdeck.realmDialogs.newRealmTitle' => 'Nuevo realm',
			'flightdeck.realmDialogs.renameRealmTitle' => 'Renombrar realm',
			'flightdeck.realmDialogs.rename' => 'Renombrar',
			'flightdeck.realmDialogs.deleteRealmTitle' => 'Eliminar realm',
			'flightdeck.realmDialogs.deleteMessage' => ({required Object name, required Object suffix}) => '¿Eliminar "${name}"? Ningún workspace se elimina — solo cambia la lista de carpetas.${suffix}',
			'flightdeck.realmDialogs.deleteSuffixOne' => ' Su workspace se moverá a Predeterminado.',
			'flightdeck.realmDialogs.deleteSuffixMany' => ({required Object count}) => ' Sus ${count} workspaces se moverán a Predeterminado.',
			'flightdeck.realmDialogs.manageRealmsTitle' => 'Gestionar realms',
			'flightdeck.realmDialogs.workspaceCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 workspace', other: '${n} workspaces', ),
			'flightdeck.dbRedisTable.deleteKeyTitle' => 'Eliminar clave',
			'flightdeck.dbRedisTable.deleteKeyMessage' => ({required Object key}) => '¿Eliminar "${key}" de esta base de datos Redis?',
			'flightdeck.dbRedisTable.refresh' => 'Actualizar',
			'flightdeck.dbRedisTable.newKey' => 'Nueva clave',
			'flightdeck.dbRedisTable.columnKey' => 'CLAVE',
			'flightdeck.dbRedisTable.columnValue' => 'VALOR',
			'flightdeck.dbRedisTable.columnType' => 'TIPO',
			'flightdeck.dbRedisTable.columnTtl' => 'TTL',
			'flightdeck.dbRedisTable.keyCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 clave', other: '${n} claves', ),
			'flightdeck.dbRedisTable.noKeys' => 'No hay claves en esta base de datos.',
			'flightdeck.dbRedisTable.noKeysMatch' => ({required Object pattern}) => 'Ninguna clave coincide con "${pattern}".',
			'flightdeck.dbRedisTable.loadMore' => 'Cargar más',
			'flightdeck.dbRedisTable.loadingFullValue' => 'Cargando valor completo…',
			'flightdeck.dbRedisTable.ttlMustBeNumber' => 'El TTL debe ser un número de segundos.',
			'flightdeck.dbRedisTable.addKey' => 'Añadir clave',
			'flightdeck.dbRedisTable.keyFieldHint' => 'clave',
			'flightdeck.dbRedisTable.ttlFieldHint' => 'ttl (s, opcional)',
			'flightdeck.dbRedisTable.valueFieldHint' => 'valor',
			'flightdeck.dbRedisTable.searchHint' => 'Buscar — patrón, ej.: user:*',
			'flightdeck.dbQueryView.saveQueryAs' => 'Guardar query como',
			'flightdeck.dbQueryView.couldNotSave' => 'No se pudo guardar',
			'flightdeck.dbQueryView.selectDatabase' => 'Seleccionar base de datos',
			'flightdeck.dbQueryView.noSqlConnections' => 'Sin conexiones SQL',
			'flightdeck.dbQueryView.running' => 'Ejecutando…',
			'flightdeck.dbQueryView.runSelection' => 'Ejecutar selección',
			'flightdeck.dbQueryView.run' => 'Ejecutar',
			'flightdeck.dbQueryView.pickDatabaseHint' => 'Elige una base de datos arriba y luego Ejecutar (⌘↵).',
			'flightdeck.dbQueryView.runQueryHint' => 'Ejecuta la query (⌘↵) para ver los resultados aquí.',
			'flightdeck.dbQueryView.noRows' => 'Sin filas.',
			'flightdeck.dbQueryView.rowsAffected' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 fila afectada', other: '${n} filas afectadas', ),
			'flightdeck.dbQueryView.rowsFooter' => ({required Object n}) => '${n} filas',
			'flightdeck.dbQueryView.truncatedSuffix' => ' · truncado (aumenta -- limit)',
			'flightdeck.dbQueryView.table' => 'Tabla',
			'flightdeck.dbQueryView.json' => 'JSON',
			'flightdeck.dbQueryView.unsaved' => 'sin guardar',
			'flightdeck.dbQueryView.saved' => 'guardado',
			'flightdeck.dbQueryView.copied' => 'Copiado',
			'flightdeck.dbQueryView.copy' => 'Copiar',
			'flightdeck.httpView.saveRequestAs' => 'Guardar request como',
			'flightdeck.httpView.couldNotSave' => 'No se pudo guardar',
			'flightdeck.httpView.run' => 'Ejecutar',
			'flightdeck.httpView.running' => 'Ejecutando…',
			'flightdeck.httpView.noRequests' => 'Ningún request en este archivo — escribe uno, p. ej.: GET https://example.com',
			'flightdeck.httpView.selectRequest' => 'Seleccionar request',
			'flightdeck.httpView.requestCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 request', other: '${n} requests', ),
			'flightdeck.httpView.runHint' => 'Ejecuta el request (⌘↵) para ver la respuesta aquí.',
			'flightdeck.httpView.emptyBody' => 'Cuerpo de la respuesta vacío.',
			'flightdeck.httpView.body' => 'JSON',
			'flightdeck.httpView.headers' => 'Headers',
			'flightdeck.httpView.raw' => 'Text',
			'flightdeck.httpView.truncatedSuffix' => ' · truncado (respuesta demasiado grande)',
			'flightdeck.httpView.error.title' => 'Falló el request',
			'flightdeck.httpView.error.noRequest' => 'No se encontró ningún request en la posición del cursor.',
			'flightdeck.httpView.error.invalidUrl' => ({required Object url}) => 'URL inválida: ${url}',
			'flightdeck.httpView.error.unresolvedVariable' => ({required Object name}) => 'La variable {{${name}}} no tiene valor. Declárala con @${name} = … en este archivo.',
			'flightdeck.httpView.error.bodyFileMissing' => ({required Object path}) => 'Archivo de cuerpo no encontrado: ${path}',
			'flightdeck.httpView.error.bodyFileUnreadable' => ({required Object path, required Object detail}) => 'No se pudo leer el archivo de cuerpo ${path}: ${detail}',
			'flightdeck.httpView.error.connectionFailed' => ({required Object detail}) => 'No se pudo alcanzar el servidor: ${detail}',
			'flightdeck.httpView.error.connectionFailedNoDetail' => 'No se pudo alcanzar el servidor.',
			'flightdeck.httpView.error.timeout' => ({required Object seconds}) => 'El request superó el tiempo límite de ${seconds}s.',
			'flightdeck.httpView.error.responseTooLarge' => ({required Object bytes}) => 'La respuesta superó el límite de ${bytes} bytes.',
			'flightdeck.kanbanView.boardView' => 'Tablero',
			'flightdeck.kanbanView.listView' => 'Lista',
			'flightdeck.kanbanView.refresh' => 'Actualizar desde el disco',
			'flightdeck.kanbanView.manageLabels' => 'Etiquetas',
			'flightdeck.kanbanView.labelsTitle' => 'Etiquetas de este tablero',
			'flightdeck.kanbanView.labelNamePlaceholder' => 'nombre de la etiqueta',
			'flightdeck.kanbanView.labelUsage' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 tarjeta', other: '${n} tarjetas', ),
			'flightdeck.kanbanView.deleteLabel' => 'Eliminar etiqueta',
			'flightdeck.kanbanView.newCard' => 'nueva tarjeta',
			'flightdeck.kanbanView.newCardTitle' => 'Nueva tarjeta',
			'flightdeck.kanbanView.newColumn' => 'Nueva columna',
			'flightdeck.kanbanView.columnNameTitle' => 'Nombre de la columna',
			'flightdeck.kanbanView.dragColumn' => 'Arrastrar columna',
			'flightdeck.kanbanView.columnOptions' => 'Opciones de la columna',
			'flightdeck.kanbanView.renameColumn' => 'Renombrar columna',
			'flightdeck.kanbanView.moveColumnLeft' => 'Mover a la izquierda',
			'flightdeck.kanbanView.moveColumnRight' => 'Mover a la derecha',
			'flightdeck.kanbanView.deleteColumn' => 'Eliminar columna',
			'flightdeck.kanbanView.newCardHere' => 'Nueva tarjeta aquí',
			'flightdeck.kanbanView.duplicateCard' => 'Duplicar',
			'flightdeck.kanbanView.cardLabels' => 'Etiquetas',
			'flightdeck.kanbanView.deleteCard' => 'Eliminar tarjeta',
			'flightdeck.kanbanView.advance' => 'Pasar a la siguiente columna',
			'flightdeck.kanbanView.advanceBack' => 'Volver una columna',
			'flightdeck.kanbanView.emptyColumn' => 'Sin tarjetas',
			'flightdeck.kanbanView.cardCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 tarjeta', other: '${n} tarjetas', ),
			'flightdeck.kanbanView.notes' => 'Nota',
			'flightdeck.kanbanView.notesPlaceholder' => 'Escribe una nota',
			'flightdeck.kanbanView.comments' => 'Comentarios',
			'flightdeck.kanbanView.addComment' => 'Añadir comentario',
			'flightdeck.kanbanView.commentPlaceholder' => 'Escribe un comentario',
			'flightdeck.kanbanView.noComments' => 'Aún no hay comentarios',
			'flightdeck.kanbanView.closeDetail' => 'Cerrar',
			'flightdeck.kanbanView.notABoard' => 'Este archivo aún no tiene columnas ## — se abre como markdown.',
			'flightdeck.kanbanView.startBoard' => 'Empezar un tablero',
			'flightdeck.kanbanView.couldNotSave' => 'No se pudo guardar el tablero',
			'flightdeck.kanbanView.unrecognizedBlock' => 'No reconocido por el analizador — se arrastra entero, sin edición en línea.',
			'flightdeck.kanbanView.deleteColumnDialog.title' => ({required Object name}) => '¿Eliminar «${name}»?',
			'flightdeck.kanbanView.deleteColumnDialog.message' => ({required Object count}) => 'Esta columna tiene ${count}. Elige qué pasa con ellas.',
			'flightdeck.kanbanView.deleteColumnDialog.moveCards' => 'Mover a la columna anterior',
			'flightdeck.kanbanView.deleteColumnDialog.deleteAll' => 'Eliminar junto con la columna',
			'flightdeck.kanbanView.deleteColumnDialog.emptyMessage' => 'Esta columna está vacía.',
			'flightdeck.dbPanel.sectionDatabase' => 'BASE DE DATOS',
			'flightdeck.dbPanel.edit' => 'Editar…',
			'flightdeck.dbPanel.copyName' => 'Copiar nombre',
			'flightdeck.dbPanel.newQuery' => 'Nueva query',
			'flightdeck.dbPanel.browseKeys' => 'Ver claves',
			'flightdeck.dbPanel.deleteConnectionTitle' => 'Eliminar conexión',
			'flightdeck.dbPanel.deleteConnectionMessage' => ({required Object name}) => '¿Quitar "${name}" de este workspace? Cualquier contraseña guardada se descartará. Los archivos .dbq que la referencian no se modifican.',
			'flightdeck.dbPanel.footer' => ({required Object n}) => '.flightdeck/databases.json · ${n} conexiones',
			'flightdeck.dbPanel.footerOne' => '.flightdeck/databases.json · 1 conexión',
			'flightdeck.dbPanel.noConnections' => 'Aún no hay conexiones.',
			'flightdeck.dbPanel.passwordRequired' => 'Contraseña no encontrada en el host. Abre esta conexión y vuelve a escribirla — se guarda en la máquina que ejecuta la base de datos, no en esta.',
			'flightdeck.dbMongoView.deleteDocumentTitle' => 'Eliminar documento',
			'flightdeck.dbMongoView.deleteDocumentMessage' => ({required Object id, required Object collection}) => '¿Eliminar el documento con _id ${id} de "${collection}"?',
			'flightdeck.dbMongoView.filterHint' => 'Filtro — JSON, ej.: {"status": "active"}',
			'flightdeck.dbMongoView.docCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 doc', other: '${n} docs', ),
			'flightdeck.dbMongoView.refresh' => 'Actualizar',
			'flightdeck.dbMongoView.insertDocument' => 'Insertar documento',
			'flightdeck.dbMongoView.noDocuments' => 'No hay documentos en esta colección.',
			'flightdeck.dbMongoView.noDocumentsMatch' => 'Ningún documento coincide con este filtro.',
			'flightdeck.dbMongoView.loadMore' => 'Cargar más',
			'flightdeck.dbMongoView.edit' => 'Editar',
			'flightdeck.dbMongoView.insert' => 'Insertar',
			'flightdeck.dbConnectionDialog.chooseFileTitle' => 'Elegir base de datos SQLite',
			'flightdeck.dbConnectionDialog.file' => 'Archivo',
			'flightdeck.dbConnectionDialog.chooseFilePlaceholder' => 'Elige un archivo SQLite…',
			'flightdeck.dbConnectionDialog.name' => 'Nombre',
			'flightdeck.dbConnectionDialog.password' => 'Contraseña',
			'flightdeck.dbConnectionDialog.savePassword' => 'Guardar contraseña',
			'flightdeck.dbConnectionDialog.allowWrites' => 'Permitir escritura (agentes)',
			'flightdeck.dbConnectionDialog.allowWritesHint' => 'desactivado = los agentes solo leen vía CLI',
			'flightdeck.dbConnectionDialog.visibleToAgents' => 'Visible para agentes',
			'flightdeck.dbConnectionDialog.visibleToAgentsHint' => 'desactivado = oculto en la CLI, solo en la GUI',
			'flightdeck.dbConnectionDialog.testing' => 'Probando conexión…',
			'flightdeck.dbConnectionDialog.connectionOk' => 'Conexión OK',
			'flightdeck.dbConnectionDialog.connectionFailed' => 'Fallo en la conexión',
			'flightdeck.dbConnectionDialog.editTitle' => 'Editar conexión',
			'flightdeck.dbConnectionDialog.newTitle' => 'Nueva conexión',
			'flightdeck.dbConnectionDialog.connectionString' => 'Connection string',
			'flightdeck.dbConnectionDialog.invalidUrl' => 'URL de conexión no válida.',
			'flightdeck.dbConnectionDialog.sshTunnel' => 'Túnel SSH',
			_ => null,
		} ?? switch (path) {
			'flightdeck.dbConnectionDialog.sshHost' => 'Host SSH',
			'flightdeck.dbConnectionDialog.sshPort' => 'Puerto SSH',
			'flightdeck.dbConnectionDialog.sshUser' => 'Usuario SSH',
			'flightdeck.dbConnectionDialog.privateKey' => 'Clave privada',
			'flightdeck.dbConnectionDialog.choosePrivateKeyPlaceholder' => 'Elige una clave privada…',
			'flightdeck.dbConnectionDialog.choosePrivateKeyDialogTitle' => 'Elegir clave privada SSH',
			'flightdeck.dbConnectionDialog.keyPassphrase' => 'Frase de contraseña de la clave',
			'flightdeck.dbConnectionDialog.savePassphrase' => 'Guardar frase de contraseña',
			'flightdeck.dbConnectionDialog.passwordOnHost' => 'La contraseña se guarda en el host, no en esta máquina.',
			'flightdeck.sshPrompts.unknownSshHostTitle' => 'Host SSH desconocido',
			'flightdeck.sshPrompts.neverConnected' => ({required Object endpoint}) => 'FlightDeck nunca se ha conectado a ${endpoint} antes.',
			'flightdeck.sshPrompts.trustHint' => 'Confía solo si esta fingerprint coincide con el servidor. Puedes verificarla en el servidor con:',
			'flightdeck.sshPrompts.trust' => 'Confiar',
			'flightdeck.sshPrompts.sshKeyPassphraseTitle' => 'Frase de contraseña de la clave SSH',
			'flightdeck.sshPrompts.unlockMessage' => ({required Object keyPath, required Object connectionName}) => 'Desbloquea ${keyPath} para conectar "${connectionName}".',
			'flightdeck.sshPrompts.keptInMemoryHint' => 'Se mantiene en memoria hasta que FlightDeck se cierre. Para que los agentes usen esta conexión, activa "Guardar frase de contraseña" en la conexión.',
			'flightdeck.sshPrompts.unlock' => 'Desbloquear',
			'flightdeck.projectsRail.workspaces' => 'Workspaces',
			'flightdeck.projectsRail.newWorkspace' => 'Nuevo workspace',
			'flightdeck.projectsRail.settings' => 'Configuración',
			'flightdeck.projectsRail.mergeToParent' => 'Fusionar en el padre',
			'flightdeck.projectsRail.updateFromParent' => 'Actualizar desde el padre',
			'flightdeck.projectsRail.forkWorktree' => 'Crear worktree derivada',
			'flightdeck.projectsRail.copyBranch' => 'Copiar branch',
			'flightdeck.projectsRail.remove' => 'Quitar',
			'flightdeck.projectsRail.moveToRealm' => 'Mover a realm',
			'flightdeck.projectsRail.copyWorkspaceId' => 'Copiar id del workspace',
			'flightdeck.projectsRail.rename' => 'Renombrar',
			'flightdeck.projectsRail.close' => 'Cerrar',
			'flightdeck.projectsRail.newRealm' => 'Nuevo realm…',
			'flightdeck.projectsRail.manageRealms' => 'Gestionar realms…',
			'flightdeck.projectsRail.noWorkspaces' => 'Aún no hay workspaces.',
			'flightdeck.projectsRail.sync' => 'Sincronizar',
			'flightdeck.projectsRail.pull' => 'Pull',
			'flightdeck.projectsRail.push' => 'Push',
			'flightdeck.projectsRail.createWorktree' => 'Crear worktree',
			'flightdeck.projectsRail.worktreeCount' => ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('es'))(n, one: '1 worktree', other: '${n} worktrees', ),
			'flightdeck.projectsRail.expandWorktrees' => 'Expandir worktrees',
			'flightdeck.projectsRail.collapseWorktrees' => 'Contraer worktrees',
			'flightdeck.findBar.find' => 'Buscar',
			'flightdeck.findBar.matchCase' => 'Coincidir mayúsculas',
			'flightdeck.findBar.wholeWord' => 'Palabra completa',
			'flightdeck.findBar.useRegex' => 'Usar expresión regular',
			'flightdeck.findBar.previous' => 'Anterior (⇧⏎)',
			'flightdeck.findBar.next' => 'Siguiente (⏎)',
			'flightdeck.findBar.close' => 'Cerrar (Esc)',
			'flightdeck.findBar.badPattern' => 'Patrón inválido',
			'flightdeck.findBar.noResults' => 'Sin resultados',
			'flightdeck.contentSearch.sectionSearch' => 'BÚSQUEDA',
			'flightdeck.contentSearch.searchInFiles' => 'Buscar en los archivos',
			'flightdeck.contentSearch.matchCase' => 'Coincidir mayúsculas',
			'flightdeck.contentSearch.wholeWord' => 'Palabra completa',
			'flightdeck.contentSearch.useRegex' => 'Usar expresión regular',
			'flightdeck.contentSearch.invalidRegex' => 'Expresión regular inválida.',
			'flightdeck.contentSearch.typeToSearch' => 'Escribe para buscar en todos los archivos.',
			'flightdeck.contentSearch.searching' => 'Buscando…',
			'flightdeck.contentSearch.noResults' => 'Sin resultados.',
			'flightdeck.emptyPane.newAgent' => 'Nuevo agente',
			'flightdeck.emptyPane.newAgentDescription' => 'Ejecuta un pi en la carpeta que elijas',
			'flightdeck.emptyPane.newTerminal' => 'Nueva terminal',
			'flightdeck.emptyPane.newTerminalDescription' => 'Abre un shell en la carpeta que elijas',
			'flightdeck.topbar.collapseSidebar' => 'Contraer barra lateral',
			'flightdeck.topbar.toggleFiles' => 'Mostrar/ocultar archivos',
			'flightdeck.topbar.filesUnavailable' => 'Archivos no disponibles en FlightDeck',
			'flightdeck.topbar.hideKeyboard' => 'Ocultar teclado',
			'flightdeck.transcript.cancel' => 'Cancelar',
			'flightdeck.transcript.send' => 'Enviar',
			'flightdeck.transcript.typeYourAnswer' => 'Escribe tu respuesta',
			'flightdeck.transcript.startHint' => 'Envía un prompt para que el agente empiece.',
			'flightdeck.transcript.workedFor' => ({required Object duration}) => 'Trabajó ${duration}',
			...
			'flightdeck.tasks.quit' => 'Salir',
			'flightdeck.notifications.agentFinished' => 'El agente terminó',
			'flightdeck.notifications.open' => 'Abrir',
			'flightdeck.notifications.agentNeedsAction' => 'El agente necesita tu acción',
			'flightdeck.notifications.agentCrashed' => 'El agente se detuvo inesperadamente',
			'flightdeck.terminal.cwdFallbackWarning' => ({required Object requested, required Object path}) => 'Aviso: la carpeta "${requested}" no existe. Esta terminal se abrió en "${path}".',
			'flightdeck.remoteHost.addHost' => 'Añadir host remoto',
			'flightdeck.remoteHost.hostName' => 'Nombre',
			'flightdeck.remoteHost.sshTarget' => 'Destino SSH (usuario@host)',
			...
			'flightdeck.remoteHost.loadingWorkspace' => 'Cargando workspace…',
			'flightdeck.remoteHost.reconnecting' => ({required Object host}) => 'Reconectando a ${host}…',
			'flightdeck.remoteHost.offline' => ({required Object host}) => '${host} sin conexión',
			'flightdeck.remoteHost.remove' => 'Quitar',
			'flightdeck.remoteHost.reconnect' => 'Reconectar',
			'flightdeck.remoteHost.installServer' => 'Instalar servidor',
			'flightdeck.remoteHost.errSshUnreachable' => ({required Object host}) => 'No se puede llegar a ${host} por SSH. ¿Está encendido y con Inicio de sesión remoto activado?',
			'flightdeck.remoteHost.errInstallFailed' => ({required Object host}) => 'No se pudo instalar el servidor en ${host}.',
			'flightdeck.remoteHost.errVersionMismatch' => 'Versión del servidor incompatible; actualízalo.',
			'flightdeck.remoteHost.errDetail' => ({required Object detail}) => 'Detalles: ${detail}',
			'flightdeck.remoteHost.pickFolderTitle' => ({required Object host}) => 'Abrir carpeta en ${host}',
			'flightdeck.remoteHost.openHere' => 'Abrir aquí',
			'flightdeck.remoteHost.emptyFolder' => 'Sin subcarpetas',
			'flightdeck.remoteHost.newLocal' => 'Local',
			'flightdeck.remoteHost.newRemote' => 'Remoto',
			'flightdeck.remoteHost.chooseHost' => 'Elegir un host',
			'flightdeck.remoteHost.newHostEntry' => 'Nuevo host…',
			'flightdeck.remoteHost.editHost' => 'Editar host',
			'flightdeck.remoteHost.userLabel' => 'Usuario',
			'flightdeck.remoteHost.hostLabel' => 'Host / IP',
			'flightdeck.remoteHost.portLabel' => 'Puerto',
			'flightdeck.remoteHost.authLabel' => 'Autenticación',
			'flightdeck.remoteHost.authKey' => 'Clave SSH',
			'flightdeck.remoteHost.authPassword' => 'Contraseña',
			'flightdeck.remoteHost.passwordLabel' => 'Contraseña',
			'flightdeck.remoteHost.passwordKeep' => 'Deja en blanco para mantener la actual',
			'flightdeck.remoteHost.errUser' => 'Usuario obligatorio',
			'flightdeck.remoteHost.errHost' => 'Host obligatorio',
			'flightdeck.remoteHost.errPassword' => 'Contraseña obligatoria',
			'flightdeck.remoteHost.identityChoose' => 'Elegir…',
			'flightdeck.remoteHost.identityEmpty' => 'Ninguna clave seleccionada',
			'flightdeck.remoteHost.identityDialogTitle' => 'Selecciona la clave privada SSH',
			'flightdeck.remoteHost.errIdentity' => 'Elige la clave privada para autenticarte.',
			'flightdeck.remoteHost.errHostKeyUnknown' => ({required Object host}) => 'FlightDeck todavía no confía en ${host}. Conecta de nuevo y confirma la huella.',
			'flightdeck.remoteHost.errHostKeyChanged' => ({required Object host}) => '${host} presenta una clave SSH distinta de la guardada. Si no reinstalaste esa máquina, detente y compruébalo; si la reinstalaste, elimina la entrada antigua de ~/.ssh/known_hosts.',
			'flightdeck.remoteHost.errHostBundleMissing' => ({required Object host}) => '${host} es Windows pero no tiene FlightDeck instalado. El servidor remoto se instala desde el bundle de FlightDeck que ya está en esa máquina — instálalo allí e inténtalo de nuevo.',
			'flightdeck.remoteHost.errHostUnknownOs' => ({required Object host}) => 'No se pudo identificar el sistema de ${host}. La cuenta puede tener un shell restringido, o ninguno.',
			'flightdeck.remoteHost.errIdentityPublic' => 'Solo está la clave pública. Eso funciona solo si la privada está en tu agente SSH; si no, elige la privada (mismo nombre, sin .pub).',
			'flightdeck.remoteHost.errIdentityNotKey' => 'Ese archivo no parece una clave privada.',
			'flightdeck.remoteHost.errIdentityMissingFile' => 'Ese archivo ya no existe.',
			'flightdeck.remoteHost.errIdentityUnreadable' => 'No se pudo leer ese archivo.',
			'flightdeck.browserPane.back' => 'Atrás',
			'flightdeck.browserPane.forward' => 'Adelante',
			'flightdeck.browserPane.reload' => 'Recargar',
			'flightdeck.browserPane.urlHint' => 'Escribe la URL o dirección',
			'flightdeck.browserPane.go' => 'Ir',
			'flightdeck.gallery.intro' => 'Documentos especiales de FlightDeck para que veas lo que el agente de IA está haciendo.',
			'flightdeck.gallery.createErrorTitle' => 'No se pudo crear el archivo',
			'flightdeck.gallery.dbQuery.title' => 'Consulta de base de datos',
			'flightdeck.gallery.dbQuery.description' => 'Editor SQL con grilla de resultados, usando una de las conexiones registradas.',
			'flightdeck.gallery.kanban.title' => 'Tablero kanban',
			'flightdeck.gallery.kanban.description' => 'Columnas y tarjetas guardadas como markdown puro. Arrastra, edita y comenta.',
			'flightdeck.gallery.layout.title' => 'Layout de paneles',
			'flightdeck.gallery.layout.description' => 'Terminales y splits para abrir de una vez, estilo tmuxinator. Puede ejecutarse solo en worktrees nuevos.',
			'flightdeck.gallery.httpRequest.title' => 'Requests HTTP',
			'flightdeck.gallery.httpRequest.description' => 'Escribe requests en un archivo y ejecútalos con la respuesta al lado.',
			'flightdeck.gallery.html.title' => 'Vista HTML',
			'flightdeck.gallery.html.description' => 'Una página que el agente escribe y FlightDeck renderiza directo: mapa mental, diagrama, gráfico, lo que necesites.',
			'flightdeck.gallery.tasks.title' => 'Tareas',
			'flightdeck.gallery.tasks.description' => 'Comandos para ejecutar desde el panel de Tasks, como dev server, tests y build. Vive en .flightdeck/tasks.json.',
			'flightdeck.gallery.notebook.title' => 'Cuaderno',
			'flightdeck.gallery.notebook.description' => 'Una carpeta de notas cortas con tags. El agente escribe, tú lees y editas. También abre en Obsidian.',
			'flightdeck.notebook.notes' => 'Notas',
			'flightdeck.notebook.newNote' => 'Nueva nota',
			'flightdeck.notebook.searchPlaceholder' => 'Buscar notas',
			'flightdeck.notebook.empty' => 'Aún no hay notas. Crea una, o pídele al agente que escriba aquí.',
			'flightdeck.notebook.noMatch' => 'Ninguna nota coincide.',
			'flightdeck.notebook.selectNote' => 'Selecciona una nota',
			'flightdeck.notebook.reload' => 'Recargar del disco',
			'flightdeck.notebook.untagged' => 'sin tag',
			'flightdeck.notebook.saveFailed' => 'No se pudo guardar la nota',
			'flightdeck.notebook.createFailed' => 'No se pudo crear la nota',
			'flightdeck.notebook.addTag' => 'añadir tag',
			'flightdeck.notebook.untitled' => 'Sin título',
			'flightdeck.notebook.deleteNote' => 'Eliminar nota',
			'flightdeck.notebook.deleteConfirm' => ({required Object name}) => '¿Mover “${name}” a la papelera?',
			'flightdeck.notebook.imageFailed' => 'No se pudo guardar la imagen',
			'flightdeck.notebook.format.bold' => 'Negrita (⌘B)',
			'flightdeck.notebook.format.italic' => 'Cursiva (⌘I)',
			'flightdeck.notebook.format.strike' => 'Tachado',
			...
			'flightdeck.notebook.format.quote' => 'Cita',
			'flightdeck.notebook.format.code' => 'Código inline (⌘E)',
			'flightdeck.notebook.format.codeBlock' => 'Bloque de código',
			'flightdeck.notebook.format.link' => 'Enlace (⌘K)',
			'flightdeck.notebook.format.rule' => 'Divisor',
			'flightdeck.notebook.format.noteLink' => 'Enlace a una nota ([[…]])',
			'flightdeck.notebook.format.noteLinkSearch' => 'Buscar notas',
			'flightdeck.notebook.format.image' => 'Insertar imagen…',
			'flightdeck.notebook.backlinks' => 'Enlazada desde',
			'flightdeck.notebook.renameTag' => 'Renombrar tag',
			'flightdeck.notebook.deleteTag' => 'Eliminar tag',
			'flightdeck.notebook.deleteTagConfirm' => ({required Object name, required Object count}) => '¿Quitar “${name}” de ${count} notas? Las notas se conservan.',
			...
			'settings.page.general.enableAgentsDesc' => 'Muestra la opción de abrir pestañas de agente (pi). Cuando está desactivado, FlightDeck funciona solo como workspace de terminal.',
			'settings.page.general.showFlightDeckTitle' => 'Mostrar terminal de FlightDeck',
			'settings.page.general.showFlightDeckDesc' => 'Mantiene un workspace sin carpeta, solo de terminal, fijado en la parte superior de la barra lateral. Desactivarlo cierra sus terminales.',
			'settings.page.general.launchAtStartupTitle' => 'Iniciar al arrancar',
			'settings.page.general.launchAtStartupDesc' => 'Inicia FlightDeck automáticamente cuando inicias sesión en tu computadora.',
			'settings.page.general.sectionUpdates' => 'Actualizaciones',
			'settings.page.general.checkUpdatesTitle' => 'Buscar actualizaciones',
			'settings.page.general.checkUpdatesDesc' => 'Con qué frecuencia FlightDeck debe buscar nuevas versiones.',
			...
			'settings.page.storage.locationDesc' => ({required Object root}) => 'FlightDeck guarda aquí sus proyectos, diseños y configuración. Apúntalo a una carpeta sincronizada para respaldarlo.\n${root}',
			...
			'settings.page.storage.resetTitle' => 'Restablecer FlightDeck',
			...
			'settings.page.storage.resetDialogTitle' => '¿Restablecer FlightDeck?',
			'settings.page.storage.resetDialogContent' => 'Esto elimina permanentemente todos los datos locales de FlightDeck — proyectos, diseños, configuración e historial de terminal. Esto no se puede deshacer. FlightDeck se cerrará para que puedas empezar de nuevo.',
			'settings.page.storage.restartRequiredTitle' => 'Reinicio necesario',
			'settings.page.storage.restartChangeFolderMessage' => ({required Object path}) => 'FlightDeck usará esta carpeta a partir del próximo inicio:\n${path}',
			'settings.page.storage.restartUseDefaultMessage' => 'FlightDeck usará la ubicación predeterminada del sistema a partir del próximo inicio. Tus datos en la carpeta personalizada permanecen intactos.',
			'settings.page.storage.restartResetMessage' => 'Se borraron todos los datos de FlightDeck. Reinicia para empezar de nuevo.',
			'settings.page.storage.later' => 'Más tarde',
			'settings.page.storage.quitFlightDeck' => 'Salir de FlightDeck',
			'settings.page.storage.chooseFolderDialogTitle' => 'Elige una carpeta para los datos de FlightDeck',
			...
			'settings.page.terminal.noWslMessage' => 'No se encontraron distros de WSL. Instala una (wsl.exe --install) y reinicia FlightDeck para verla listada aquí.',
			...
			'settings.page.notifications.grantedDesc' => 'FlightDeck tiene permiso para enviar notificaciones.',
			...
			'settings.page.languages.footerNote' => 'Los errores y el formato usan el language server de cada lenguaje. FlightDeck no instala servidores — usa lo que ya está en tu máquina. ● responde · ○ no encontrado o comando inválido (instala el servidor o ajusta el comando).',
			...
			'settings.page.automations.generateFromSourceControlDescription' => 'FlightDeck envía solo el diff seleccionado y los asuntos de los commits recientes. Los patrones habituales de credenciales y los archivos sensibles se redactan antes de ejecutar el harness.',
			...
			'settings.remoteHosts.helpBody' => 'FlightDeck se conecta a tu máquina por SSH y habla con un pequeño servidor que ejecuta las terminales, archivos y git allí. El host debe tener FlightDeck (escritorio) o el flightdeck-server instalado y en ejecución, y la clave pública de este dispositivo añadida en su ~/.ssh/authorized_keys.',
