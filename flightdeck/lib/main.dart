...
import 'package:flightdeck/app/bootstrapper.dart';
import 'package:flightdeck/app/core/data/diagnostics/diagnostics_log.dart';
import 'package:flightdeck/app/core/data/diagnostics/error_handlers.dart';
import 'package:flightdeck/app/core/ui/widgets/app_error_view.dart';
...
/// [FlightDeckBootstrapper]: a janela abre imediatamente com tela de loading e o
...
Future<void> main() async {
  await runGuarded(() async {
    ...
    runApp(TranslationProvider(child: const FlightDeckBootstrapper()));
  });
}
