...
/// fake, nenhum banco é aberto. Usa o tema real do FlightDeck pra avaliar o visual
...
class DbTabMockupApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ShadcnApp(
      title: 'FlightDeck — DB Tab (mockup)',
      debugShowCheckedModeBanner: false,
      scrollBehavior: const ClampingScrollBehavior(),
      theme: buildTheme(brightness: Brightness.dark),
      builder: (context, child) => FlightDeckTheme(
...
/// Simula o pane central do FlightDeck: uma tab strip fake com a tab `app.db`
...
/// **Database** com as conexões do workspace (`.flightdeck/databases.json` +
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '.flightdeck/databases.json · 3 connections',
...
/// No app real isso persiste em `.flightdeck/databases.json` como
