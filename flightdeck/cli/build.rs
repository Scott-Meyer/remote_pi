...
//! porque um FlightDeck de dev e um instalado rodam lado a lado. A CLI é
...
//! `FLIGHTDECK_FLAVOR=debug` nos builds de desenvolvimento.

fn main() {
    println!("cargo:rerun-if-env-changed=FLIGHTDECK_FLAVOR");
}
