...
num workspace do FlightDeck — o equivalente a um layout de tmuxinator. Um arquivo
...
2. **CLI interna** — `flightdeck orchestrate dev.ckp` (de dentro de uma tab).
...
O FlightDeck trata `.ckp` como YAML (highlight) e mostra o logo do FlightDeck como
