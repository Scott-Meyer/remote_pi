...
/// Host = o mesmo empilhamento do `AppRoot`: ShadcnApp + FlightDeckTheme (que é a
/// origem do `context.typo` usado nos rótulos do menu). Sem o FlightDeckTheme o
