...
void main() {
  test(
    ...
    () {
      ...
      final command = CliAutomationGateway.buildCommand(
        selection,
        'prompt',
        codexSystemPromptPath: '/tmp/flightdeck-system.md',
      );
      ...
      expect(
        command.args,
        contains('model_instructions_file="/tmp/flightdeck-system.md"'),
      );
  ...
  test('Pi discovery and generation share the same isolation flags', () {
    ...
    // o próprio FlightDeck tinha oferecido.
  ...
  test('harnesses without an account catalog do not offer a model choice', () {
    ...
    // modo interativo, então o FlightDeck não inventa uma lista.
  ...
  test('redacts credentials and validates generated messages', () {
    ...
    expect(prompt, contains('[sensitive line redacted by FlightDeck]'));
