...
worktree /home/jacob/proj/.flightdeck/worktrees/feature
HEAD bbbb
branch refs/heads/feature
''';
      final entries = RemoteWorktreeGateway.parsePorcelain(out, repo);
      expect(entries.length, 1);
      expect(entries.single.path, '$repo/.flightdeck/worktrees/feature');
...
worktree /home/jacob/proj/.flightdeck/worktrees/wip
HEAD cccc
detached
''';
      final entries = RemoteWorktreeGateway.parsePorcelain(out, repo);
