...
void main() {
  ...
  setUp(() async {
    dir = await Directory.systemTemp.createTemp('flightdeck_diag_test');
  });
  ...
  group('DiagnosticsLog', () {
    ...
    test('grava boot e erro no arquivo do dia', () async {
      ...
      expect(content, contains('[boot] FlightDeck 1.0.0'));
    ...
    test('rotate apaga log além da retenção e preserva o recente', () async {
      final velho = File('${dir.path}/flightdeck-2020-01-01.log');
      ...
      final novo = File('${dir.path}/flightdeck-recente.log');
    ...
    test('rotate ignora arquivos que não são log do flightdeck', () async {
