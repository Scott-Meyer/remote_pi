...
import 'package:flightdeck/app/flightdeck/data/db/anaki_db_driver.dart';
...
/// pacote anaki (issue #4), não do FlightDeck.
void main() {
  ...
  setUp(() async {
    dir = await Directory.systemTemp.createTemp('flightdeck_anaki_test');
