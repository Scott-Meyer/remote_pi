...
class Hello extends RemoteMessage {
  ...
  /// mantêm o `FLIGHTDECK_STATUS_SOCK` que ELE injetou, porque aquele socket é a
  /// via da CLI interna (`flightdeck send`, `list-tabs`, `db`...) além do status
...
class HelloAck extends RemoteMessage {
  ...
  /// `flightdeck_server`, que quase nunca muda entre releases do app e portanto
...
/// O cliente roteia por [paneId] (o `FLIGHTDECK_PANE_ID` da aba) e reusa o mesmo
...
class TurnStatus extends RemoteMessage {
  ...
  /// Aba dona (o `FLIGHTDECK_PANE_ID` que o cliente injetou e o host reportou).
  final String paneId;
