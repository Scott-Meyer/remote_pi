...
export const metadata: Metadata = {
  ...
  description:
    "Use FlightDeck's multiplexer to run an orchestrator, a backend, and a frontend agent side by side — each in its own folder with its own AGENTS.md, coordinating over the remote-pi mesh.",
};
...
export default function FlightDeckTeamTutorial() {
  return (
    <div className="page">
          ...
          <div className="tut">
            <header className="page-head reveal" style={{ maxWidth: "none" }}>
              <div className="flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center rounded-full border border-accent/40 bg-accent/15 px-3 py-1 text-xs font-semibold uppercase tracking-[0.15em] text-accent">
                  FlightDeck · multi-agent
                </span>
              </div>
              <span className="eyebrow" style={{ marginTop: 14 }}>
                Tutorial · FlightDeck
              </span>
              <h1>An agent team in FlightDeck</h1>
              <p className="lede">
                FlightDeck&apos;s real power is the multiplexer: many agents in one
            ...
            <article className="prose">
              <DocsSection id="what" title="What you'll build">
                <p>
                  Three Pi agents, side by side as panes in a single FlightDeck
              ...
              <DocsSection id="prereqs" title="Before you start">
                <ul className="ml-6 list-disc space-y-2">
                  <li>
                    <strong className="text-fg">FlightDeck installed</strong> — grab
                    it from the{" "}
...
└── frontend/
    └── AGENTS.md`}
              ...
              <DocsSection id="panes" title="2. Open the three panes">
                <p>
                  In FlightDeck, open <InlineCode>my-app/</InlineCode> as a workspace.
                  ...
                  and create an agent there — FlightDeck roots that agent in the
...
→ Delivered to orchestrator`}
              ...
              <DocsSection id="why" title="Why do this in FlightDeck">
                <p>
                  You could run three terminals — but in FlightDeck the whole team
            ...
            <Pager
              ...
              next={{ href: "/flightdeck", label: "Meet FlightDeck" }}
            />
          </div>
        </div>
      </div>
