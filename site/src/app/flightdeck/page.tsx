...
const pageTitle = "FlightDeck: Just a terminal. Until your agents need more.";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    url: "https://remote-pi.jacobmoura.work/flightdeck",
    title: pageTitle,
    description: pageDescription,
    siteName: "Remote Pi",
  },
...
function Shot({
  ...
  return (
    <div
      className="flightdeck-shot reveal"
      ...
      <div className="page-body">
        <div className="wrap">
          ...
          <header className="page-head reveal" style={{ maxWidth: 820 }}>
            <span className="eyebrow">Remote Pi FlightDeck</span>
          ...
          <div className="flightdeck-shot reveal">
            <Image
              src="/flightdeck/hero-terminals.png"
              alt="Remote Pi FlightDeck as a multiplexed terminal: several real shells split across panes, with a workspace sidebar and file tree."
              width={3456}
              height={2168}
              priority
              sizes="(max-width: 1180px) 100vw, 1180px"
          ...
          <section id="agents">
            ...
            <Shot
              src="/flightdeck/agent-diff-diagnostics.png"
              alt="An agent working in a FlightDeck tab on a git worktree, with an inline green-and-red diff and new diagnostic issues reported."
              width={3456}
              height={2182}
            />
          </section>
          ...
          <section id="ide">
            ...
            <Shot
              src="/flightdeck/code-viewer.png"
              alt="FlightDeck's code viewer showing a Dart file with syntax highlighting, styled documentation comments, and a file path breadcrumb."
              width={2270}
              height={2080}
            />
          </section>
          ...
          <section id="database">
            <div className="section-head reveal" style={{ marginTop: 110 }}>
              ...
              <p>
                ...
                <code>flightdeck db</code>.
              </p>
            </div>
            <Shot
              src="/flightdeck/database-panel.png"
              alt="FlightDeck's Database panel listing Postgres, MySQL, SQL Server, Redis, MongoDB, and an auto-detected SQLite connection."
              width={1116}
              height={1150}
              maxWidth={620}
            />
          ...
          {/* ---------------- AGENTS DRIVE THE FLIGHTDECK ---------------- */}
          <section id="cli">
            <div className="section-head reveal" style={{ marginTop: 110 }}>
              <span className="eyebrow">An agentic tmux</span>
              <h2>Agents drive the flightdeck.</h2>
              <p>
                A built-in <code>flightdeck</code> CLI, available only inside its
...
flightdeck send --tab-id "$id" --enter "pnpm test"

# read what it printed
flightdeck read-tab Worker --lines 60
...
flightdeck open src/app.ts
flightdeck db query --db dev-local --sql "SELECT * FROM orders" --limit 50`}
              />
          ...
          <section id="layouts">
            <div className="section-head reveal" style={{ marginTop: 110 }}>
              ...
              <p>
                ...
                every new worktree. A <code>.flightdeck/tasks.json</code> turns
                your dev servers into play/stop buttons with profiles and
                reload on save, on top of the tasks FlightDeck already detects
    ...
    command: npm run dev`}
          ...
          <section id="status">
            <div className="section-head reveal" style={{ marginTop: 110 }}>
              ...
              <p>
                FlightDeck hooks into Claude Code and Codex CLI, so each tab shows
                ...
                FlightDeck simply reports nothing.
              </p>
            </div>
          </section>
          ...
          >
            <span className="eyebrow">Get FlightDeck</span>
            <h2
              style={{
            ...
            >
              ...
              <Link className="btn btn-ghost" href="/flightdeck/docs">
                Reference <IconArrow />
              </Link>
              <a
